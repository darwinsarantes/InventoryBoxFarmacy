...
namespace InventoryBoxFarmacy.Formularios
{
    public partial class frmCategoriaOperacion : Form
    {
        ...
        private void frmCategoriaOperacion_Shown(object sender, EventArgs e)
        {
        ...
        {
            chkCerrarVentana.CheckState = (Properties.Settings.Default.CategoriaVentanaDespuesDeOperacion == true ? CheckState.Checked : CheckState.Unchecked);
            this.CerrarVentana = (Properties.Settings.Default.CategoriaVentanaDespuesDeOperacion == true ? true : false);
        }
        ...
        {
            Properties.Settings.Default.CategoriaVentanaDespuesDeOperacion = (chkCerrarVentana.CheckState == CheckState.Checked ? true : false);
        ...
        private bool LosDatosIngresadosSonCorrectos()
        {
            ...
            {
                EP.SetError(txtCategoria, "Este campo no puede quedar vacío");
                txtCategoria.Focus();
                return false;
            }
        ...
        private CategoriaEN InformacionDelRegistro() {

            CategoriaEN oRegistroEN = new CategoriaEN();

            oRegistroEN.idCategoria = Convert.ToInt32((txtIdentificador.Text.Length > 0 ? txtIdentificador.Text : "0"));
            oRegistroEN.Nombre = txtCategoria.Text.Trim();
        ...
        private void frmCategoriaOperacion_FormClosing(object sender, FormClosingEventArgs e)
        {
