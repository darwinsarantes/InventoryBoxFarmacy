...
namespace InventoryBoxFarmacy.Formularios
{
    public partial class frmAlmacen : Form
    {
        ...
        public AlmacenEN[] oAlmacen = new AlmacenEN[0];
        ...
        private DataTable ConvertirClassADT()
        {
            ...
            System.Xml.Serialization.XmlSerializer serializer = new System.Xml.Serialization.XmlSerializer(oAlmacen.GetType());
            System.IO.StringWriter sw = new System.IO.StringWriter();
            serializer.Serialize(sw, oAlmacen);
                ...
                foreach (DataGridViewColumn c1 in dgvLista.Columns)
                {
                    if (c1.Visible == true)
                    {
                        if (c1.Name.Trim().ToUpper() != "Seleccionar".ToUpper())
                        {
                            ...
                            {
                                oFormato = new FormatoDGV(c1.Name.Trim(), "Almacen");
                            }
        ...
        private void MostrarFormularioParaOperacion(string OperacionesARealizar)
        {
            ...
            frmAlmacenOperacion ofrmAlmacenOperacion = new frmAlmacenOperacion();
            ofrmAlmacenOperacion.OperacionARealizar = OperacionesARealizar;
            ofrmAlmacenOperacion.NOMBRE_ENTIDAD_PRIVILEGIO = NOMBRE_ENTIDAD_PRIVILEGIO;
            ofrmAlmacenOperacion.NombreEntidad = NOMBRE_ENTIDAD;
            ofrmAlmacenOperacion.ValorLlavePrimariaEntidad = this.ValorLlavePrimariaEntidad;
            ofrmAlmacenOperacion.MdiParent = this.ParentForm;
            ofrmAlmacenOperacion.Show();
        ...
        private void frmAlmacen_Shown(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (dgvLista.Rows.Count > 0)
                {
                    foreach (DataGridViewRow Fila in dgvLista.Rows)
                    {
                        ...
                        {
                            a++;
                            Array.Resize(ref oAlmacen, a);

                            oAlmacen[a - 1] = new AlmacenEN();
        ...
        private void txtDesAlmacen_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            else { chkAlmacen.CheckState = CheckState.Checked; }
