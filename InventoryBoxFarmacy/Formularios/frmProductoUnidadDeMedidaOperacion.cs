...
{
    public partial class frmProductoUnidadDeMedidaOperacion : Form
    {
        public frmProductoUnidadDeMedidaOperacion()
        {
            InitializeComponent();
        }
        ...
        private void frmProductoUnidadDeMedidaOperacion_Shown(object sender, EventArgs e)
        {
        ...
        {
            chkCerrarVentana.CheckState = (Properties.Settings.Default.ProductoUnidadDeMedidaVentanaDespuesDeOperacion == true ? CheckState.Checked : CheckState.Unchecked);
            this.CerrarVentana = (Properties.Settings.Default.ProductoUnidadDeMedidaVentanaDespuesDeOperacion == true ? true : false);
        }
        ...
        private void DeshabilitarControlesSegunOperacionesARealizar()
        {
            switch (this.OperacionARealizar.ToUpper())
            {
                case "NUEVO":
                    ...
                    txtProductoUnidadDeMedida.Text = string.Empty;                                    
                ...
                case "ELIMINAR":
                    ...
                    txtProductoUnidadDeMedida.ReadOnly = true;
        ...
        private void LlenarCamposDesdeBaseDatosSegunID()
        {
            ...
            oRegistrosEN.idProductoUnidadDeMedida = ValorLlavePrimariaEntidad;
            ...
            if (oRegistrosLN.ListadoPorIdentificador(oRegistrosEN, Program.oDatosDeConexion))
            {
                if (oRegistrosLN.TraerDatos().Rows.Count > 0)
                {
                    ...
                    txtProductoUnidadDeMedida.Text = Fila["Nombre"].ToString();
                    txtDescripcion.Text = Fila["Descripcion"].ToString();
                    txtAbreviatura.Text = Fila["Abreviatura"].ToString();
        ...
        {
            Properties.Settings.Default.ProductoUnidadDeMedidaVentanaDespuesDeOperacion = (chkCerrarVentana.CheckState == CheckState.Checked ? true : false);
        ...
        private bool LosDatosIngresadosSonCorrectos()
        {
            ...
            {
                EP.SetError(txtProductoUnidadDeMedida, "Este campo no puede quedar vacío");
                txtProductoUnidadDeMedida.Focus();
                return false;
            }
        ...
        private ProductoUnidadDeMedidaEN InformacionDelRegistro() {

            ProductoUnidadDeMedidaEN oRegistroEN = new ProductoUnidadDeMedidaEN();

            oRegistroEN.idProductoUnidadDeMedida = Convert.ToInt32((txtIdentificador.Text.Length > 0 ? txtIdentificador.Text : "0"));
            oRegistroEN.Nombre = txtProductoUnidadDeMedida.Text.Trim();
            oRegistroEN.Descripcion = txtDescripcion.Text.Trim();
            oRegistroEN.Abreviatura = txtAbreviatura.Text.Trim();
        ...
        private void frmProductoUnidadDeMedidaOperacion_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void tsbGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (LosDatosIngresadosSonCorrectos())
                {
                    ...
                    ProductoUnidadDeMedidaEN oRegistroEN = InformacionDelRegistro();
                    ...
                    if (oRegistroLN.Agregar(oRegistroEN, Program.oDatosDeConexion))
                    {
                        ...
                        txtIdentificador.Text = oRegistroEN.idProductoUnidadDeMedida.ToString();
                        ValorLlavePrimariaEntidad = oRegistroEN.idProductoUnidadDeMedida;
