...
{
    public partial class frmTipoDeEntidadOperacion : Form
    {
        public frmTipoDeEntidadOperacion()
        {
            InitializeComponent();
        }
        ...
        private void frmTipoDeEntidadOperacion_Shown(object sender, EventArgs e)
        {
        ...
        {
            chkCerrarVentana.CheckState = (Properties.Settings.Default.TipoDeEntidadVentanaDespuesDeOperacion == true ? CheckState.Checked : CheckState.Unchecked);
            this.CerrarVentana = (Properties.Settings.Default.TipoDeEntidadVentanaDespuesDeOperacion == true ? true : false);
        }
        ...
        private void DeshabilitarControlesSegunOperacionesARealizar()
        {
            switch (this.OperacionARealizar.ToUpper())
            {
                case "NUEVO":
                    ...
                    txtDesTipoDeEntidad.Text = string.Empty;                                    
                ...
                case "ELIMINAR":
                    ...
                    txtDesTipoDeEntidad.ReadOnly = true;
        ...
        {
            Properties.Settings.Default.TipoDeEntidadVentanaDespuesDeOperacion = (chkCerrarVentana.CheckState == CheckState.Checked ? true : false);
        ...
        private bool LosDatosIngresadosSonCorrectos()
        {
            ...
            {
                EP.SetError(txtDesTipoDeEntidad, "Este campo no puede quedar vacío");
                txtDesTipoDeEntidad.Focus();
                return false;
            }
        ...
        private TipoDeEntidadEN InformacionDelRegistro() {

            TipoDeEntidadEN oRegistroEN = new TipoDeEntidadEN();

            oRegistroEN.idTipoDeEntidad = Convert.ToInt32((txtIdentificador.Text.Length > 0 ? txtIdentificador.Text : "0"));
            oRegistroEN.Nombre = txtDesTipoDeEntidad.Text.Trim();
            oRegistroEN.NombreInterno = txtDesTipoDeEntidad.Text.Trim();
        ...
        private void frmTipoDeEntidadOperacion_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void tsbGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (LosDatosIngresadosSonCorrectos())
                {
                    ...
                    TipoDeEntidadEN oRegistroEN = InformacionDelRegistro();
                    TipoDeEntidadLN oRegistroLN = new TipoDeEntidadLN();
                    ...
                    if (oRegistroLN.Agregar(oRegistroEN, Program.oDatosDeConexion))
                    {
                        ...
                        txtIdentificador.Text = oRegistroEN.idTipoDeEntidad.ToString();
                        ValorLlavePrimariaEntidad = oRegistroEN.idTipoDeEntidad;
