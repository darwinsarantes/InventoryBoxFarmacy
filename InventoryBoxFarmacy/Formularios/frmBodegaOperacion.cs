...
{
    public partial class frmBodegaOperacion : Form
    {
        public frmBodegaOperacion()
        {
            InitializeComponent();
        }
        ...
        #region "Funciones"
            ...
            {
                chkCerrarVentana.CheckState = (Properties.Settings.Default.BodegaVentanaDespuesDeOperacion == true ? CheckState.Checked : CheckState.Unchecked);
                this.CerrarVentana = (Properties.Settings.Default.BodegaVentanaDespuesDeOperacion == true ? true : false);
            }
            ...
            {
                Properties.Settings.Default.BodegaVentanaDespuesDeOperacion = (chkCerrarVentana.CheckState == CheckState.Checked ? true : false);
            ...
            private BodegaEN InformacionDelRegistro() {
        ...
        #region "Eventos del formulario"
            ...
            private void frmBodegaOperacion_FormClosing(object sender, FormClosingEventArgs e)
            {
                ...
                try
                {
                    ...
                    if (LosDatosIngresadosSonCorrectos())
                    {
                        ...
                        if (oRegistroLN.AgregarUtilizandoLaMismaConexion(oRegistroEN, Program.oDatosDeConexion))
                        {
                            ...
                            ValorLlavePrimariaEntidad = oRegistroEN.idBodega;
            ...
            private void tsbNueva_Click(object sender, EventArgs e)
            {
                ...
                try
                {
                    ...
                    frmLocacionOperacion ofrmRegistro = new frmLocacionOperacion();
                    ofrmRegistro.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
                    ofrmRegistro.OperacionARealizar = "Local";
                    ofrmRegistro.NombreEntidad = "Agregar información del Estante/Vitrina/Caja del Producto";
                    ofrmRegistro.ShowDialog();
        ...
        private void CraerColumnasDGVRegistrar()
            {
                try
                {
        ...
        private LocacionEN InformacionDeLaLocacion(DataGridViewRow Fila)
        {
                ...
                if (dgvListar.Rows.Count > 0)
                {
                    ...
                    foreach (DataGridViewRow Fila in dgvListar.Rows)
                    {
                        ...
                        if (IdLocacion.Trim().Length == 0)
                        {
                            if (idLocacion > 0)
                            {
                                IdLocacion = idLocacion.ToString();
                            }
                        }
                        else
                        {
                            if (idLocacion > 0)
                            {
                                IdLocacion = string.Format("{0}, {1}", IdLocacion, idLocacion.ToString());
                            }
                        }
                    }
