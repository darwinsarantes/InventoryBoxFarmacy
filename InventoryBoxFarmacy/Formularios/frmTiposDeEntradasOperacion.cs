...
{
    public partial class frmTiposDeEntradasOperacion : Form
    {
        public frmTiposDeEntradasOperacion()
        {
            InitializeComponent();
        }
        ...
        private void frmTiposDeEntradasOperacion_Shown(object sender, EventArgs e)
        {
        ...
        {
            chkCerrarVentana.CheckState = (Properties.Settings.Default.TiposDeEntradasVentanaDespuesDeOperacion == true ? CheckState.Checked : CheckState.Unchecked);
            this.CerrarVentana = (Properties.Settings.Default.TiposDeEntradasVentanaDespuesDeOperacion == true ? true : false);
        }
        ...
        private void LlenarCamposDesdeBaseDatosSegunID()
        {
            ...
            oRegistrosEN.idTipoDeEntrada = ValorLlavePrimariaEntidad;
        ...
        {
            Properties.Settings.Default.TiposDeEntradasVentanaDespuesDeOperacion = (chkCerrarVentana.CheckState == CheckState.Checked ? true : false);
        ...
        private TiposDeEntradasEN InformacionDelRegistro() {

            TiposDeEntradasEN oRegistroEN = new TiposDeEntradasEN();

            oRegistroEN.idTipoDeEntrada = Convert.ToInt32((txtIdentificador.Text.Length > 0 ? txtIdentificador.Text : "0"));
        ...
        private void frmTiposDeEntradasOperacion_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void tsbGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (LosDatosIngresadosSonCorrectos())
                {
                    ...
                    TiposDeEntradasEN oRegistroEN = InformacionDelRegistro();
                    TiposDeEntradasLN oRegistroLN = new TiposDeEntradasLN();
                    ...
                    if (oRegistroLN.Agregar(oRegistroEN, Program.oDatosDeConexion))
                    {
                        ...
                        txtIdentificador.Text = oRegistroEN.idTipoDeEntrada.ToString();
                        ValorLlavePrimariaEntidad = oRegistroEN.idTipoDeEntrada;
