...
namespace InventoryBoxFarmacy.Formularios
{
    public partial class frmSeccion : Form
    {
        ...
        private DataTable ConvertirClassADT()
        {
            ...
            System.Xml.Serialization.XmlSerializer serializer = new System.Xml.Serialization.XmlSerializer(oSeccion.GetType());
            System.IO.StringWriter sw = new System.IO.StringWriter();
            serializer.Serialize(sw, oSeccion);
        ...
        private void MostrarFormularioParaOperacion(string OperacionesARealizar)
        {
            ...
            frmSeccionOperacion ofrmSeccionOperacion = new frmSeccionOperacion();
            ofrmSeccionOperacion.OperacionARealizar = OperacionesARealizar;
            ofrmSeccionOperacion.NOMBRE_ENTIDAD_PRIVILEGIO = NOMBRE_ENTIDAD_PRIVILEGIO;
            ofrmSeccionOperacion.NombreEntidad = NOMBRE_ENTIDAD;
            ofrmSeccionOperacion.ValorLlavePrimariaEntidad = this.ValorLlavePrimariaEntidad;
            ofrmSeccionOperacion.MdiParent = this.ParentForm;
            ofrmSeccionOperacion.Show();
        ...
        private void frmSeccion_Shown(object sender, EventArgs e)
        {
        ...
        private void frmSeccion_KeyUp(object sender, KeyEventArgs e)
        {
        ...
        private void txtDesSeccion_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            else { chkSeccion.CheckState = CheckState.Checked; }
