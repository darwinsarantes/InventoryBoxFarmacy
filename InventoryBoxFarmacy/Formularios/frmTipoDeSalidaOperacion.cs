...
{
    public partial class frmTipoDeSalidaOperacion : Form
    {
        public frmTipoDeSalidaOperacion()
        {
            InitializeComponent();
        }
        ...
        private void frmTipoDeSalidaOperacion_Shown(object sender, EventArgs e)
        {
        ...
        {
            chkCerrarVentana.CheckState = (Properties.Settings.Default.TipoDeSalidaVentanaDespuesDeOperacion == true ? CheckState.Checked : CheckState.Unchecked);
            this.CerrarVentana = (Properties.Settings.Default.TipoDeSalidaVentanaDespuesDeOperacion == true ? true : false);
        }
        ...
        {
            Properties.Settings.Default.TipoDeSalidaVentanaDespuesDeOperacion = (chkCerrarVentana.CheckState == CheckState.Checked ? true : false);
        ...
        private TipoDeSalidaEN InformacionDelRegistro() {
        ...
        private void frmTipoDeSalidaOperacion_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void tsbGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (LosDatosIngresadosSonCorrectos())
                {
                    ...
                    TipoDeSalidaEN oRegistroEN = InformacionDelRegistro();
                    TipoDeSalidaLN oRegistroLN = new TipoDeSalidaLN();
                    ...
                    if (oRegistroLN.Agregar(oRegistroEN, Program.oDatosDeConexion))
                    {
                        ...
                        txtIdentificador.Text = oRegistroEN.idTipoDeSalida.ToString();
                        ValorLlavePrimariaEntidad = oRegistroEN.idTipoDeSalida;
