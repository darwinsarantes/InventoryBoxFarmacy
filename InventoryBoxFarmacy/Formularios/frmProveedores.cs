...
namespace InventoryBoxFarmacy.Formularios
{
    public partial class frmProveedores : Form
    {
        ...
        private string NOMBRE_ENTIDAD_PRIVILEGIO = "Proveedores";
        private string NOMBRE_ENTIDAD = "Administrar proveedores";
        ...
        public ProveedorEN[] oProveedores = new ProveedorEN[0];
        ...
        private DataTable ConvertirClassADT()
        {
            ...
            System.Xml.Serialization.XmlSerializer serializer = new System.Xml.Serialization.XmlSerializer(oProveedores.GetType());
            System.IO.StringWriter sw = new System.IO.StringWriter();
            serializer.Serialize(sw, oProveedores);
        ...
        private string TituloDinamico()
        {
            ...
            if (Controles.IsNullOEmptyElControl(chkProveedor) == false && Controles.IsNullOEmptyElControl(txtProveedor) == false)
            {
                Titulo += string.Format(" Proveedor: '{0}', ", txtProveedor.Text.Trim());
            }
        ...
        private void FormatearDGV()
        {
            try
            {
                ...
                string OcultarColumnas = "idProveedor, Observaciones, Correo, FechaDeCumpleanos, Messenger, Skype, Twitter, Facebook, Estado, Foto, idUsuarioDeCreacion, FechaDeCreacion, idUsuarioModificacion, FechaDeModificacion";
        ...
        private void MostrarFormularioParaOperacion(string OperacionesARealizar)
        {
            ...
            frmProveedoresOperacion ofrmProveedoresOperacion = new frmProveedoresOperacion();
            ofrmProveedoresOperacion.OperacionARealizar = OperacionesARealizar;
            ofrmProveedoresOperacion.NOMBRE_ENTIDAD_PRIVILEGIO = NOMBRE_ENTIDAD_PRIVILEGIO;
            ofrmProveedoresOperacion.NombreEntidad = NOMBRE_ENTIDAD;
            ofrmProveedoresOperacion.ValorLlavePrimariaEntidad = this.ValorLlavePrimariaEntidad;
            ofrmProveedoresOperacion.MdiParent = this.ParentForm;
            ofrmProveedoresOperacion.Show(); 
            ...
            try
            {
                ...
                if (dgvLista.Rows.Count > 0)
                {
                    foreach (DataGridViewRow Fila in dgvLista.Rows)
                    {
                        ...
                        {
                            a++;
                            Array.Resize(ref oProveedores, a);
                            /**/
                            oProveedores[a - 1] = new ProveedorEN();
                            oProveedores[a - 1].idProveedor = Convert.ToInt32(Fila.Cells["idProveedor"].Value);
                            oProveedores[a - 1].Nombre = Fila.Cells["Nombre"].Value.ToString();
                            oProveedores[a - 1].Codigo = Fila.Cells["Codigo"].Value.ToString();
                            oProveedores[a - 1].Direccion = Fila.Cells["Direccion"].Value.ToString();
                            oProveedores[a - 1].NoRUC = Fila.Cells["NoRUC"].Value.ToString();
                            oProveedores[a - 1].SitioWeb = Fila.Cells["SitioWeb"].Value.ToString();
                            oProveedores[a - 1].Telefono = Fila.Cells["Telefono"].Value.ToString();
                            oProveedores[a - 1].Movil = Fila.Cells["Movil"].Value.ToString();
                            oProveedores[a - 1].Observaciones = Fila.Cells["Observaciones"].Value.ToString();
                            oProveedores[a - 1].Correo = Fila.Cells["Correo"].Value.ToString();
                            oProveedores[a - 1].FechaDeCumpleanos = Fila.Cells["FechaDeCumpleanos"].Value.ToString();
                            oProveedores[a - 1].Messenger = Fila.Cells["Messenger"].Value.ToString();
                            oProveedores[a - 1].Skype = Fila.Cells["Skype"].Value.ToString();
                            oProveedores[a - 1].Twitter = Fila.Cells["Twitter"].Value.ToString();
                            oProveedores[a - 1].Facebook = Fila.Cells["Facebook"].Value.ToString();
                            oProveedores[a - 1].Estado = Fila.Cells["Estado"].Value.ToString();
        ...
        {
            frmExportarProveedores oImportar = new frmExportarProveedores();
