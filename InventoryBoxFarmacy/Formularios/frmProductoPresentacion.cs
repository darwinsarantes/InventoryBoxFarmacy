    ...
    public partial class frmProductoPresentacion : Form
    {
        ...
        private void FormatearDGV()
        {
            try
            {
                ...
                string OcultarColumnas = "idUsuarioDeCreacion, FechaDeCreacion, idUsuarioModificacion, FechaDeModificacion, UsuarioDeCreacion, UsuarioDeModificacion";
        ...
        private void txtAbreviatura_KeyUp(object sender, KeyEventArgs e)
        {
            if (Controles.IsNullOEmptyElControl(txtAbreviatura))
            {
                chkAbreviatura.CheckState = CheckState.Unchecked;
            }
            else { chkAbreviatura.CheckState = CheckState.Checked; }

            if (chkAbreviatura.CheckState == CheckState.Checked && tsbFiltroAutomatico.CheckState == CheckState.Checked)
            {
                LLenarListado();
            }
        }
