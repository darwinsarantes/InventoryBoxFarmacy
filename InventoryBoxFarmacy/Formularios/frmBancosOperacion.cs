...
{
    public partial class frmBancosOperacion : Form
    {
        public frmBancosOperacion()
        {
            InitializeComponent();
        }
        ...
        private void frmBancosOperacion_Shown(object sender, EventArgs e)
        {
        ...
        {
            chkCerrarVentana.CheckState = (Properties.Settings.Default.BancosVentanaDespuesDeOperacion == true ? CheckState.Checked : CheckState.Unchecked);
            this.CerrarVentana = (Properties.Settings.Default.BancosVentanaDespuesDeOperacion == true ? true : false);
        }
        ...
        {
            Properties.Settings.Default.BancosVentanaDespuesDeOperacion = (chkCerrarVentana.CheckState == CheckState.Checked ? true : false);
        ...
        private BancosEN InformacionDelRegistro() {

            BancosEN oRegistroEN = new BancosEN();

            oRegistroEN.idBancos = Convert.ToInt32((txtIdentificador.Text.Length > 0 ? txtIdentificador.Text : "0"));
        ...
        private void frmBancosOperacion_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void tsbGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (LosDatosIngresadosSonCorrectos())
                {
                    ...
                    BancosEN oRegistroEN = InformacionDelRegistro();
                    BancosLN oRegistroLN = new BancosLN();
                    ...
                    if (oRegistroLN.Agregar(oRegistroEN, Program.oDatosDeConexion))
                    {
                        ...
                        txtIdentificador.Text = oRegistroEN.idBancos.ToString();
                        ValorLlavePrimariaEntidad = oRegistroEN.idBancos;
