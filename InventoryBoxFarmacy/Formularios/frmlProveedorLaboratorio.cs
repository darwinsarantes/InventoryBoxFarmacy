...
{
    public partial class frmlProveedorLaboratorio : Form
    {
        public frmlProveedorLaboratorio()
        {
            InitializeComponent();
        }

        private string NOMBRE_ENTIDAD_PRIVILEGIO = "Bodega";
        private string NOMBRE_ENTIDAD = "Administrar los diferentes Bodegas y espacios donde caeran las secciones del para almacenar el producto";
        ...
        public ProveedorLaboratorioEN[] oProveedorLaboratorioEN = new ProveedorLaboratorioEN[0];
        ...
        private void AgregarRegistrosAlDTUsuario()
        {
            ...
            if (oProveedorLaboratorioEN.Length > 0)
            {
        ...
        private DataTable ConvertirClassADT()
        {
            ...
            System.Xml.Serialization.XmlSerializer serializer = new System.Xml.Serialization.XmlSerializer(oProveedorLaboratorioEN.GetType());
            System.IO.StringWriter sw = new System.IO.StringWriter();
            serializer.Serialize(sw, oProveedorLaboratorioEN);
        ...
        private string WhereDinamico() {
            ...
            string TablaDeReferencia = dgvLista.Rows[0].Cells["TablaDeReferencia"].Value.ToString();            
            switch (TablaDeReferencia.Trim())
            {
                case "ProveedorLaboratorio":                    
                    Where += WhereDinamicoProductoLaboratorio();
                    break;

                default:                    
                    Where += WhereDinamicoProductoOLaboratorio();                    
                    break;
        ...
        private string WhereDinamicoProductoLaboratorio()
        {
            string Where = "";

            if (Controles.IsNullOEmptyElControl(txtBuscarProveedorLaboratorio) == false)
            {
                Where += string.Format(" and T.Proveedor like '%{0}%' or T.Laboratorio like '%{0}%' ", txtBuscarProveedorLaboratorio.Text.Trim());
            }
            
            return Where;
        }

        private string WhereDinamicoProductoOLaboratorio()
        {
            string Where = "";

            if (Controles.IsNullOEmptyElControl(txtBuscarProveedorLaboratorio) == false)
            {
                Where += string.Format(" and T.ProveedorLaboratorio like '%{0}%' ", txtBuscarProveedorLaboratorio.Text.Trim());
            }
        ...
        private void FormatearDGV()
        {
            try
            {
                ...
                string OcultarColumnas = "idProveedorLaboratorio,TablaDeReferencia";
            ...
            if (dgvLista.Columns.Count > 0)
            {
                ...
                foreach (DataGridViewColumn c1 in dgvLista.Columns)
                {
                    if (c1.Visible == true)
                    {
                        ...
                        {
                            FormatoDGV oFormato = new FormatoDGV(c1.Name.Trim(), "ProductoLaboratorio");
        ...
        private void frmlProveedorLaboratorio_Shown(object sender, EventArgs e)
        {            
            ...
            try
            {
                ...
                if (dgvLista.Rows.Count > 0)
                {
                    foreach (DataGridViewRow Fila in dgvLista.Rows)
                    {
                        ...
                        {
                            a++;
                            Array.Resize(ref oProveedorLaboratorioEN, a);                            
                            ProveedorLaboratorioEN oRegistroEN = new ProveedorLaboratorioEN();
                            
                            oRegistroEN.idProveedorLaboratorio = Convert.ToInt32(Fila.Cells["idProveedorLaboratorio"].Value.ToString());
                            ...
                            switch (oRegistroEN.TablaDeReferencia)
                            {
                                ...
                                case "ProveedorLaboratorio":
                                    oRegistroEN.ProveedorLaboratorio = Fila.Cells["Laboratorio"].Value.ToString();
                                    break;

                                default:
                                    oRegistroEN.ProveedorLaboratorio = Fila.Cells["ProveedorLaboratorio"].Value.ToString();
                                    break;
        ...
        private void frmlProveedorLaboratorio_KeyUp(object sender, KeyEventArgs e)
        {
        ...
        private void txtBuscarProveedorLaboratorio_KeyUp(object sender, KeyEventArgs e)
        {
