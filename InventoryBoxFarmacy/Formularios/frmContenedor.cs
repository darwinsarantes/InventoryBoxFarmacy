...
namespace InventoryBoxFarmacy.Formularios
{
    public partial class frmContenedor : Form
    {
        ...
        private string NOMBRE_ENTIDAD_PRIVILEGIO = "Contenedor";
        private string NOMBRE_ENTIDAD = "Administrar los diferentes espacios para guardar los productos";
        private string NOMBRE_LLAVE_PRIMARIA = "idContenedor";
        ...
        public ContenedorEN[] oContenedor = new ContenedorEN[0];
        ...
        private DataTable ConvertirClassADT()
        {
            ...
            System.Xml.Serialization.XmlSerializer serializer = new System.Xml.Serialization.XmlSerializer(oContenedor.GetType());
            System.IO.StringWriter sw = new System.IO.StringWriter();
            serializer.Serialize(sw, oContenedor);
        ...
        private void MostrarFormularioParaOperacion(string OperacionesARealizar)
        {
            ...
            frmContenedorOperacion ofrmContenedorOperacion = new frmContenedorOperacion();
            ofrmContenedorOperacion.OperacionARealizar = OperacionesARealizar;
            ofrmContenedorOperacion.NOMBRE_ENTIDAD_PRIVILEGIO = NOMBRE_ENTIDAD_PRIVILEGIO;
            ofrmContenedorOperacion.NombreEntidad = NOMBRE_ENTIDAD;
            ofrmContenedorOperacion.ValorLlavePrimariaEntidad = this.ValorLlavePrimariaEntidad;
            ofrmContenedorOperacion.MdiParent = this.ParentForm;
            ofrmContenedorOperacion.Show();
        ...
        private void frmContenedor_Shown(object sender, EventArgs e)
        {
        ...
        private void frmContenedor_KeyUp(object sender, KeyEventArgs e)
        {
        ...
        private void txtDesContenedor_KeyUp(object sender, KeyEventArgs e)
        {
            if (Controles.IsNullOEmptyElControl(txtNombre))
            {
                chkContenedor.CheckState = CheckState.Unchecked;
            }
            else { chkContenedor.CheckState = CheckState.Checked; }

            if (chkContenedor.CheckState == CheckState.Checked && tsbFiltroAutomatico.CheckState == CheckState.Checked)
            {
                LLenarListado();
            }
        }
