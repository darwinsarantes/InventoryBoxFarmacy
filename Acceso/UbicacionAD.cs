    ...
    public class UbicacionAD
    {
        ...
        public bool Agregar(UbicacionEN oRegistroEN, DatosDeConexionEN oDatos) {
            ...
            try
            {
                ...
                (Nombre, Descripcion, 
                idUsuarioDeCreacion, FechaDeCreacion, idUsuarioModificacion, FechaDeModificacion, idTipoDeUbicacion)
                values
                (@Nombre, @Descripcion, 
                @idUsuarioDeCreacion, current_timestamp(), @idUsuarioModificacion, current_timestamp(), @idTipoDeUbicacion);
                ...
                Comando.Parameters.Add(new MySqlParameter("@idTipoDeUbicacion", MySqlDbType.Int32)).Value = oRegistroEN.oTipoDeUbicacionEN.idTipoDeUbicacion;
                ...
                oRegistroEN.idUbicacion = Convert.ToInt32(DT.Rows[0].ItemArray[0].ToString());
        ...
        public bool Actualizar(UbicacionEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                Consultas = @"update ubicacion set

	                Nombre = @Nombre, 
                    Descripcion = @Descripcion, 
	                idUsuarioModificacion = @idUsuarioModificacion, 
                    FechaDeModificacion = current_timestamp(),
                    idTipoDeUbicacion = @idTipoDeUbicacion

                Where idUbicacion = @idUbicacion;";

                Comando.CommandText = Consultas;

                Comando.Parameters.Add(new MySqlParameter("@idUbicacion", MySqlDbType.Int32)).Value = oRegistroEN.idUbicacion;
                Comando.Parameters.Add(new MySqlParameter("@Nombre", MySqlDbType.VarChar, oRegistroEN.Nombre.Trim().Length)).Value = oRegistroEN.Nombre.Trim();
                Comando.Parameters.Add(new MySqlParameter("@Descripcion", MySqlDbType.VarChar, oRegistroEN.Descripcion.Trim().Length)).Value = oRegistroEN.Descripcion.Trim();
                Comando.Parameters.Add(new MySqlParameter("@idTipoDeUbicacion", MySqlDbType.Int32)).Value = oRegistroEN.oTipoDeUbicacionEN.idTipoDeUbicacion;
                Comando.Parameters.Add(new MySqlParameter("@idUsuarioModificacion", MySqlDbType.Int32)).Value = oRegistroEN.oLoginEN.idUsuario;                
        ...
        public bool Eliminar(UbicacionEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                Consultas = @"Delete from Ubicacion Where idUbicacion = @idUbicacion;";
                Comando.CommandText = Consultas;
        ...
        public bool Listado(UbicacionEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                Consultas = string.Format(@"Select idUbicacion,ub.idTipoDeUbicacion, ub.Nombre, tu.Nombre as 'TipoDeUbicacion', ub.Descripcion, ub.idUsuarioDeCreacion, 
                ...
                where idUbicacion > 0  {0} {1} ", oRegistroEN.Where, oRegistroEN.OrderBy);
                Comando.CommandText = Consultas;
...
inner join usuario as u on u.idUsuario = ub.idUsuarioDeCreacion
left join usuario as u1 on u1.idUsuario = ub.idUsuarioModificacion
where idUbicacion = {0} ", oRegistroEN.idUbicacion);
                Comando.CommandText = Consultas;
        ...
        public bool ListadoParaCombos(UbicacionEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                Consultas = string.Format(@"Select idUbicacion, ub.Nombre
                from ubicacion as ub                
                where idUbicacion > 0  {0} {1} ; ", oRegistroEN.Where, oRegistroEN.OrderBy);
                Comando.CommandText = Consultas;
...
where idUbicacion > 0  {0} {1} ", oRegistroEN.Where, oRegistroEN.OrderBy);
        ...
        public bool ValidarSiElRegistroEstaVinculado(UbicacionEN oRegistroEN, DatosDeConexionEN oDatos, string TipoDeOperacion)
        {
            ...
            try
            {
                ...
                Comando.Parameters.Add(new MySqlParameter("@CampoABuscar_", MySqlDbType.VarChar, 200)).Value = "idUbicacion";
                Comando.Parameters.Add(new MySqlParameter("@ValorCampoABuscar", MySqlDbType.Int32)).Value = oRegistroEN.idUbicacion;
            ...
            try
            {
                ...
                switch (TipoDeOperacion.Trim().ToUpper()){
                    ...
                    case "AGREGAR":
                        ...
                        Consultas = @"SELECT CASE WHEN EXISTS(Select idUbicacion from Ubicacion where upper( trim(Nombre) ) = upper(trim(@Nombre)) and idTipoDeUbicacion = @idTipoDeUbicacion) THEN 1 ELSE 0 END AS 'RES'";
                    ...
                    case "ACTUALIZAR":
                        ...
                        Consultas = @"SELECT CASE WHEN EXISTS(Select idUbicacion from Ubicacion where upper( trim(Nombre) ) = upper(trim(@Nombre)) and idTipoDeUbicacion = @idTipoDeUbicacion and idUbicacion <> @idUbicacion) THEN 1 ELSE 0 END AS 'RES'";
                        Comando.Parameters.Add(new MySqlParameter("@Nombre", MySqlDbType.VarChar, oRegistroEN.Nombre.Trim().Length)).Value = oRegistroEN.Nombre;
                        Comando.Parameters.Add(new MySqlParameter("@idUbicacion", MySqlDbType.Int32)).Value = oRegistroEN.idUbicacion;
                        Comando.Parameters.Add(new MySqlParameter("@idTipoDeUbicacion", MySqlDbType.Int32)).Value = oRegistroEN.oTipoDeUbicacionEN.idTipoDeUbicacion;
        ...
        private TransaccionesEN InformacionDelaTransaccion(UbicacionEN oUbicacion, String TipoDeOperacion, String Descripcion, String Estado)
        {
            TransaccionesEN oRegistroEN = new TransaccionesEN();

            oRegistroEN.idregistro = oUbicacion.idUbicacion;
            oRegistroEN.Modelo = "General";
            oRegistroEN.Modulo = "UbicacionAD";
            oRegistroEN.Tabla = "Ubicacion";
            oRegistroEN.tipodeoperacion = TipoDeOperacion;
            oRegistroEN.Estado = Estado;
            oRegistroEN.ip = oUbicacion.oLoginEN.NumeroIP;
            oRegistroEN.idusuario = oUbicacion.oLoginEN.idUsuario;
            oRegistroEN.idusuarioaprueba = oUbicacion.oLoginEN.idUsuario;
            oRegistroEN.descripciondelusuario = DescripcionDeOperacion;
            oRegistroEN.descripcioninterna = Descripcion;
            oRegistroEN.NombreDelEquipo = oUbicacion.oLoginEN.NombreDelComputador;

            return oRegistroEN;
        }
        
        private string InformacionDelRegistro(UbicacionEN oRegistroEN) {
            string Cadena = @"idUbicacion: {0}, Nombre: {1}, Descripcion: {2}, idUsuarioDeCreacion: {3}, FechaDeCreacion: {4}, idUsuarioModificacion: {5}, FechaDeModificacion: {6}, idTipoDeUbicacion: {7}";
            Cadena = string.Format(Cadena, oRegistroEN.idUbicacion, oRegistroEN.Nombre, oRegistroEN.Descripcion, oRegistroEN.idUsuarioDeCreacion, oRegistroEN.FechaDeCreacion, oRegistroEN.idUsuarioModificacion, oRegistroEN.FechaDeModificacion, oRegistroEN.oTipoDeUbicacionEN.idTipoDeUbicacion);
