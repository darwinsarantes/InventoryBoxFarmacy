    ...
    public class LocacionAD
    {
        ...
        public bool Agregar(LocacionEN oRegistroEN, DatosDeConexionEN oDatos) {
            ...
            try
            {
                ...
                (idBodega, Codigo, Nombre, Descripcion, idUsuarioDeCreacion, FechaDeCreacion, idUsuarioModificacion, FechaDeModificacion)
                values
                (@idBodega, @Codigo, @Nombre, @Descripcion, @idUsuarioDeCreacion, current_timestamp(), @idUsuarioModificacion, current_timestamp());
        ...
        public bool Listado(LocacionEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                l.idLocacion, l.idBodega, 
                concat(a.Codigo,'-',b.Codigo,'-',l.Codigo) as 'CodigoDeAlmacenaje',
                l.Codigo, l.Nombre, l.Descripcion, 
                l.idUsuarioDeCreacion, l.FechaDeCreacion, u.Nombre as 'UsuarioDeCreacion',
                l.idUsuarioModificacion, l.FechaDeModificacion , u1.Nombre as 'UsuarioDeModificacion'
                from locacion as l 
                inner join bodega as b on b.idBodega = l.idBodega
                inner join almacen as a on a.idAlmacen = b.idAlmacen
                inner join usuario as u on u.idUsuario = l.idUsuarioDeCreacion
                inner join usuario as u1 on u1.idUsuario = l.idUsuarioModificacion
                Where l.idLocacion > 0  {0} {1} ", oRegistroEN.Where, oRegistroEN.OrderBy);
                Comando.CommandText = Consultas;
        ...
        public bool ListadoPorIdDeBodega(LocacionEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                Consultas = string.Format(@"Select 
                l.idLocacion, l.idBodega, l.Codigo, l.Nombre, l.Descripcion
                from locacion as l
                inner join bodega as b on b.idBodega = l.idBodega
                where l.idBodega = {0} {1} ", oRegistroEN.oBodegaEN.idBodega, oRegistroEN.OrderBy);
                Comando.CommandText = Consultas;
        ...
        public bool ListadoPorIdentificador(LocacionEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                Consultas = string.Format(@"Select 
                l.idLocacion, l.idBodega, a.idAlmacen,
                l.Codigo, l.Nombre, l.Descripcion
                from locacion as l 
                inner join bodega as b on b.idBodega = l.idBodega
                inner join almacen as a on a.idAlmacen = b.idAlmacen
                where l.idLocacion = {0} ", oRegistroEN.idLocacion);
                Comando.CommandText = Consultas;
        ...
        public bool ListadoParaCombos(LocacionEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                Consultas = string.Format(@"Select idLocacion, Codigo, Nombre, concat(Codigo,' - ', Nombre) as 'Locacion' 
                from locacion
        ...
        public bool ValidarSiElRegistroEstaVinculado(LocacionEN oRegistroEN, DatosDeConexionEN oDatos, string TipoDeOperacion)
        {
            ...
            try
            {
                ...
                Comando.Parameters.Add(new MySqlParameter("@ExcluirTabla_", MySqlDbType.VarChar, 200)).Value = "'locacion'";
        ...
        public bool VerificarSiLaEntidadEstaAsociadaAProducto(LocacionEN oRegistroEN, DatosDeConexionEN oDatos, string TipoDeOperacion)
        {
            ...
            try
            {
                ...
                where p.TablaDeReferenciaDeAlmacenaje = 'Locacion' and p.idAlmacenEntidad = {0}) then 1 else 0 end as 'ID'", oRegistroEN.idLocacion);
            ...
            try
            {
                ...
                switch (TipoDeOperacion.Trim().ToUpper()){
                    ...
                    case "AGREGAR":
                        ...
                        Consultas = @"SELECT CASE WHEN EXISTS(Select idLocacion from Locacion where idBodega = @idBodega and upper( trim(Nombre) ) = upper(trim(@Nombre))) THEN 1 ELSE 0 END AS 'RES'";
                    ...
                    case "ACTUALIZAR":
                        ...
                        Consultas = @"SELECT CASE WHEN EXISTS(Select idLocacion from Locacion where idBodega = @idBodega and upper( trim(Nombre) ) = upper(trim(@Nombre)) and idLocacion <> @idLocacion) THEN 1 ELSE 0 END AS 'RES'";
                        Comando.Parameters.Add(new MySqlParameter("@Nombre", MySqlDbType.VarChar, oRegistroEN.Nombre.Trim().Length)).Value = oRegistroEN.Nombre;
                        Comando.Parameters.Add(new MySqlParameter("@idBodega", MySqlDbType.Int32)).Value = oRegistroEN.oBodegaEN.idBodega;
                        Comando.Parameters.Add(new MySqlParameter("@idLocacion", MySqlDbType.Int32)).Value = oRegistroEN.idLocacion;
            ...
            try
            {
                ...
                switch (TipoDeOperacion.Trim().ToUpper())
                {
                    ...
                    case "AGREGAR":
                        ...
                        Consultas = @"SELECT CASE WHEN EXISTS(Select idLocacion from Locacion where idBodega = @idBodega and upper( trim(Codigo) ) = upper(trim(@Codigo))) THEN 1 ELSE 0 END AS 'RES'";
                    ...
                    case "ACTUALIZAR":
                        ...
                        Consultas = @"SELECT CASE WHEN EXISTS(Select idLocacion from Locacion where idBodega = @idBodega and upper( trim(Codigo) ) = upper(trim(@Codigo)) and idLocacion <> @idLocacion) THEN 1 ELSE 0 END AS 'RES'";
                        Comando.Parameters.Add(new MySqlParameter("@Codigo", MySqlDbType.VarChar, oRegistroEN.Codigo.Trim().Length)).Value = oRegistroEN.Codigo;
                        Comando.Parameters.Add(new MySqlParameter("@idBodega", MySqlDbType.Int32)).Value = oRegistroEN.oBodegaEN.idBodega;
                        Comando.Parameters.Add(new MySqlParameter("@idLocacion", MySqlDbType.Int32)).Value = oRegistroEN.idLocacion;
