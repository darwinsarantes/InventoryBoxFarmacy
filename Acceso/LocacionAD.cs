    ...
    public class LocacionAD
    {
        ...
        public bool Agregar(LocacionEN oRegistroEN, DatosDeConexionEN oDatos) {
            ...
            try
            {
                ...
                (idLocacion,Codigo,Nombre, Descripcion, 
                ...
                Comando.Parameters.Add(new MySqlParameter("@idLocacion", MySqlDbType.Int32)).Value = oRegistroEN.idLocacion;
                ...
                oRegistroEN.idLocacion = Convert.ToInt32(DT.Rows[0].ItemArray[0].ToString());
        ...
        public bool Agregar(LocacionEN oRegistroEN, DatosDeConexionEN oDatos, ref MySqlConnection Cnn_Existente, ref MySqlTransaction Transaccion_Existe)
        {
            ...
            try
            {
                ...
                Comando.Transaction = Transaccion_Existe;
                Comando.CommandType = CommandType.Text;

                Consultas = @"
                                
                insert into Locacion 
                (idLocacion,Nombre, Codigo, Descripcion, 
                idUsuarioDeCreacion, FechaDeCreacion, idUsuarioModificacion, FechaDeModificacion)
                values
                (@idLocacion,@Nombre, @Codigo, @Descripcion, 
                @idUsuarioDeCreacion, current_timestamp(), @idUsuarioModificacion, current_timestamp());";
        ...
        public bool AgregarUtilizandoLaMismaConexion(LocacionEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                oEntidadEN.oTipoDeEntidadEN.Nombre = "Locacion";
                oEntidadEN.oTipoDeEntidadEN.NombreInterno = "locacion";
                ...
                {
                    oRegistroEN.idLocacion = oEntidadEN.idEntidad;
                ...
                {
                    mensaje = String.Format("Error : '{1}', {0} producido al intentar guardar la información de la locación. ", Environment.NewLine, this.Error);
                    throw new System.ArgumentException(mensaje);
                }
        ...
        public bool Eliminar(LocacionEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                Consultas = @"Delete from Locacion Where idLocacion = @idLocacion;";
                Comando.CommandText = Consultas;
        ...
        public bool Eliminar(LocacionEN oRegistroEN, DatosDeConexionEN oDatos, ref MySqlConnection Cnn_Existente, ref MySqlTransaction Transaccion_Existente)
        {
            oTransaccionesAD = new TransaccionesAD();
        ...
        public bool EliminarUtilizandoLaMismaConexion(LocacionEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                //Debemos agrear la Entidad Correspondiente
                EntidadEN oEntidadEN = new EntidadEN();
                oEntidadEN.idEntidad = oRegistroEN.idLocacion;
                oEntidadEN.oTipoDeEntidadEN.Nombre = "Locacion";
                oEntidadEN.oTipoDeEntidadEN.NombreInterno = "locacion";
                oEntidadEN.oLoginEN = oRegistroEN.oLoginEN;
                oEntidadEN.IdUsuarioDeCreacion = oRegistroEN.oLoginEN.idUsuario;
                ...
                {
                    mensaje = String.Format("Error : '{1}', {0} producido al intentar eliminar la información en la locación. ", Environment.NewLine, this.Error);
                    throw new System.ArgumentException(mensaje);
                }
            ...
            catch (Exception ex)
            {
                ...
                DescripcionDeOperacion = string.Format("Se produjo el seguiente error: '{2}' al insertar el registro. {0} {1} ", Environment.NewLine, InformacionDelRegistro(oRegistroEN), ex.Message);
                //Agregamos la Transacción....
                TransaccionesEN oTran = InformacionDelaTransaccion(oRegistroEN, "ELIMINAR", "Eliminar el Registro", "ERROR");
                oTransaccionesAD.Agregar(oTran, oDatos);
        ...
        public bool Listado(LocacionEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                lc.idLocacion, lc.Codigo, lc.Nombre, lc.Descripcion, lc.
                idUsuarioDeCreacion, lc.FechaDeCreacion, u.Nombre as 'UsuarioDeCreacion',
                lc.idUsuarioModificacion, lc.FechaDeModificacion, u1.Nombre as 'UsuarioDeModificacion'
                 from locacion as lc
                inner join usuario as u on u.idUsuario = lc.idUsuarioDeCreacion
                left join usuario as u1 on u1.idUsuario = lc.idUsuarioModificacion
                Where lc.idLocacion > 0  {0} {1} ", oRegistroEN.Where, oRegistroEN.OrderBy);
                Comando.CommandText = Consultas;
        ...
        public bool ListadoPorIdentificador(LocacionEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                inner join usuario as u on u.idUsuario = lc.idUsuarioDeCreacion
                left join usuario as u1 on u1.idUsuario = lc.idUsuarioModificacion
                Where lc.idLocacion  = {0} ", oRegistroEN.idLocacion);
                Comando.CommandText = Consultas;
        ...
        public bool ListadoParaCombos(LocacionEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                Consultas = string.Format(@"Select idLocacion, lc.Nombre
                from Locacion as lc                
                where idLocacion > 0  {0} {1} ; ", oRegistroEN.Where, oRegistroEN.OrderBy);
                Comando.CommandText = Consultas;
        ...
        public bool ValidarSiElRegistroEstaVinculado(LocacionEN oRegistroEN, DatosDeConexionEN oDatos, string TipoDeOperacion)
        {
            ...
            try
            {
                ...
                Comando.Parameters.Add(new MySqlParameter("@CampoABuscar_", MySqlDbType.VarChar, 200)).Value = "idLocacion";
                Comando.Parameters.Add(new MySqlParameter("@ValorCampoABuscar", MySqlDbType.Int32)).Value = oRegistroEN.idLocacion;
                Comando.Parameters.Add(new MySqlParameter("@ExcluirTabla_", MySqlDbType.VarChar, 200)).Value = "'Entidad','locacionseccion'";
            ...
            try
            {
                ...
                switch (TipoDeOperacion.Trim().ToUpper()){
                    ...
                    case "AGREGAR":
                        ...
                        Consultas = @"SELECT CASE WHEN EXISTS(Select idLocacion from Locacion where upper( trim(Nombre) ) = upper(trim(@Nombre))) THEN 1 ELSE 0 END AS 'RES'";
                    ...
                    case "ACTUALIZAR":
                        ...
                        Consultas = @"SELECT CASE WHEN EXISTS(Select idLocacion from Locacion where upper( trim(Nombre) ) = upper(trim(@Nombre)) and idLocacion <> @idLocacion) THEN 1 ELSE 0 END AS 'RES'";
                        Comando.Parameters.Add(new MySqlParameter("@Nombre", MySqlDbType.VarChar, oRegistroEN.Nombre.Trim().Length)).Value = oRegistroEN.Nombre;
                        Comando.Parameters.Add(new MySqlParameter("@idLocacion", MySqlDbType.Int32)).Value = oRegistroEN.idLocacion;
            ...
            try
            {
                ...
                switch (TipoDeOperacion.Trim().ToUpper())
                {
                    ...
                    case "AGREGAR":
                        ...
                        Consultas = @"SELECT CASE WHEN EXISTS(Select idLocacion from Locacion where upper( trim(Codigo) ) = upper(trim(@Codigo))) THEN 1 ELSE 0 END AS 'RES'";
                    ...
                    case "ACTUALIZAR":
                        ...
                        Consultas = @"SELECT CASE WHEN EXISTS(Select idLocacion from Locacion where upper( trim(Codigo) ) = upper(trim(@Codigo)) and idLocacion <> @idLocacion) THEN 1 ELSE 0 END AS 'RES'";
                        Comando.Parameters.Add(new MySqlParameter("@Codigo", MySqlDbType.VarChar, oRegistroEN.Codigo.Trim().Length)).Value = oRegistroEN.Codigo;
                        Comando.Parameters.Add(new MySqlParameter("@idLocacion", MySqlDbType.Int32)).Value = oRegistroEN.idLocacion;
        ...
        private TransaccionesEN InformacionDelaTransaccion(LocacionEN oLocacion, String TipoDeOperacion, String Descripcion, String Estado)
        {
            TransaccionesEN oRegistroEN = new TransaccionesEN();

            oRegistroEN.idregistro = oLocacion.idLocacion;
            oRegistroEN.Modelo = "General";
            oRegistroEN.Modulo = "LocacionAD";
            oRegistroEN.Tabla = "Locacion";
            oRegistroEN.tipodeoperacion = TipoDeOperacion;
            oRegistroEN.Estado = Estado;
            oRegistroEN.ip = oLocacion.oLoginEN.NumeroIP;
            oRegistroEN.idusuario = oLocacion.oLoginEN.idUsuario;
            oRegistroEN.idusuarioaprueba = oLocacion.oLoginEN.idUsuario;
            oRegistroEN.descripciondelusuario = DescripcionDeOperacion;
            oRegistroEN.descripcioninterna = Descripcion;
            oRegistroEN.NombreDelEquipo = oLocacion.oLoginEN.NombreDelComputador;

            return oRegistroEN;
        }
        
        private string InformacionDelRegistro(LocacionEN oRegistroEN) {
            string Cadena = @"idLocacion: {0}, Nombre: {1}, Descripcion: {2}, idUsuarioDeCreacion: {3}, FechaDeCreacion: {4}, idUsuarioModificacion: {5}, FechaDeModificacion: {6}";
            Cadena = string.Format(Cadena, oRegistroEN.idLocacion, oRegistroEN.Nombre, oRegistroEN.Descripcion, oRegistroEN.idUsuarioDeCreacion, oRegistroEN.FechaDeCreacion, oRegistroEN.idUsuarioModificacion, oRegistroEN.FechaDeModificacion);
