    ...
    public class BodegaAD
    {
        ...
        public bool Agregar(BodegaEN oRegistroEN, DatosDeConexionEN oDatos) {
            ...
            try
            {
                ...
                INSERT INTO Bodega
                (idBodega, Codigo,Nombre, Descripcion, PorDefectoParaFacturacion, 
        ...
        public bool Agregar(BodegaEN oRegistroEN, DatosDeConexionEN oDatos, ref MySqlConnection Cnn_Existente, ref MySqlTransaction Transaccion_Existente)
        {
        ...
        public bool AgregarUtilizandoLaMismaConexion(BodegaEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                oEntidadEN.oTipoDeEntidadEN.Nombre = "Bodega";
                oEntidadEN.oTipoDeEntidadEN.NombreInterno = "bodega";
                ...
                {
                    oRegistroEN.idBodega = oEntidadEN.idEntidad;
        ...
        public bool Actualizar(BodegaEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                Consultas = @"UPDATE Bodega SET
                    Codigo = @Codigo,
	                Nombre = @Nombre, Descripcion = @Descripcion, PorDefectoParaFacturacion = @PorDefectoParaFacturacion, 
        ...
        public bool Eliminar(BodegaEN oRegistroEN, DatosDeConexionEN oDatos, ref MySqlConnection Cnn_Existente, ref MySqlTransaction Transacciones_Existente)
        {
            oTransaccionesAD = new TransaccionesAD();
            ...
            try
            {
                Comando = new MySqlCommand();
                Comando.Connection = Cnn_Existente;
                Comando.Transaction = Transacciones_Existente;
                Comando.CommandType = CommandType.Text;
        ...
        public bool EliminarUtilizandoLaMismaConexion(BodegaEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                //Debemos agrear la Entidad Correspondiente
                EntidadEN oEntidadEN = new EntidadEN();
                oEntidadEN.idEntidad = oRegistroEN.idBodega;
                oEntidadEN.oTipoDeEntidadEN.Nombre = "Bodega";
                oEntidadEN.oTipoDeEntidadEN.NombreInterno = "bodega";
                oEntidadEN.oLoginEN = oRegistroEN.oLoginEN;
                oEntidadEN.IdUsuarioDeCreacion = oRegistroEN.oLoginEN.idUsuario;
                ...
                {
                    mensaje = String.Format("Error : '{1}', {0} producido al intentar eliminar la información en la Bodega. ", Environment.NewLine, this.Error);
                    throw new System.ArgumentException(mensaje);
                }
        ...
        public bool Listado(BodegaEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                Consultas = string.Format(@"Select a.idBodega, a.Codigo, a.Nombre, a.Descripcion, a.PorDefectoParaFacturacion, 
...
inner join usuario as u on u.idUsuario = a.idUsuarioDeCreacion
left join usuario as u1 on u1.idUsuario = a.idUsuarioModificacion
where a.idBodega = {0} ", oRegistroEN.idBodega);
                Comando.CommandText = Consultas;
        ...
        public bool ValidarSiElRegistroEstaVinculado(BodegaEN oRegistroEN, DatosDeConexionEN oDatos, string TipoDeOperacion)
        {
            ...
            try
            {
                ...
                Comando.Parameters.Add(new MySqlParameter("@ExcluirTabla_", MySqlDbType.VarChar, 200)).Value = "'Entidad', 'bodegalocacion'";
            ...
            try
            {
                ...
                switch (TipoDeOperacion.Trim().ToUpper()) {
                    ...
                    case "AGREGAR":
                        ...
                        Consultas = @"SELECT CASE WHEN EXISTS(Select idBodega from Bodega where upper( trim(Nombre) ) = upper(trim(@Nombre))) THEN 1 ELSE 0 END AS 'RES'";
                    ...
                    case "ACTUALIZAR":
                        ...
                        Consultas = @"SELECT CASE WHEN EXISTS(Select idBodega from Bodega where upper( trim(Nombre) ) = upper(trim(@Nombre)) and idBodega <> @idBodega) THEN 1 ELSE 0 END AS 'RES'";
                        Comando.Parameters.Add(new MySqlParameter("@Nombre", MySqlDbType.VarChar, oRegistroEN.Nombre.Trim().Length)).Value = oRegistroEN.Nombre;
                        Comando.Parameters.Add(new MySqlParameter("@idBodega", MySqlDbType.Int32)).Value = oRegistroEN.idBodega;
            ...
            try
            {
                ...
                switch (TipoDeOperacion.Trim().ToUpper())
                {
                    ...
                    case "AGREGAR":
                        ...
                        Consultas = @"SELECT CASE WHEN EXISTS(Select idBodega from Bodega where upper( trim(Codigo) ) = upper(trim(@Codigo))) THEN 1 ELSE 0 END AS 'RES'";
                    ...
                    case "ACTUALIZAR":
                        ...
                        Consultas = @"SELECT CASE WHEN EXISTS(Select idBodega from Bodega where upper( trim(Codigo) ) = upper(trim(@Codigo)) and idBodega <> @idBodega) THEN 1 ELSE 0 END AS 'RES'";
                        Comando.Parameters.Add(new MySqlParameter("@Codigo", MySqlDbType.VarChar, oRegistroEN.Codigo.Trim().Length)).Value = oRegistroEN.Codigo;
                        Comando.Parameters.Add(new MySqlParameter("@idBodega", MySqlDbType.Int32)).Value = oRegistroEN.idBodega;
