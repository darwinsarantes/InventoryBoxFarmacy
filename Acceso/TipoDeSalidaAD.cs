    ...
    public class TipoDeSalidaAD
    {
        ...
        public bool Agregar(TipoDeSalidaEN oRegistroEN, DatosDeConexionEN oDatos) {
            ...
            try
            {
                ...
                INSERT INTO tipodesalida
                (Nombre, Descripcion, idUsuarioDeCreacion, FechaDeCreacion, idUsuarioModificacion, FechaDeModificacion)
                VALUES
                (@Nombre, @Descripcion, @idUsuarioDeCreacion, current_timestamp(), @idUsuarioModificacion, current_timestamp());
                ...
                oRegistroEN.idTipoDeSalida = Convert.ToInt32(DT.Rows[0].ItemArray[0].ToString());
        ...
        public bool Actualizar(TipoDeSalidaEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                Consultas = @"UPDATE TipoDeSalida SET
	                Nombre = @Nombre, Descripcion = @Descripcion, idUsuarioModificacion = @idUsuarioModificacion, FechaDeModificacion = current_timestamp()
                WHERE idTipoDeSalida = @idTipoDeSalida";

                Comando.CommandText = Consultas;

                Comando.Parameters.Add(new MySqlParameter("@idTipoDeSalida", MySqlDbType.Int32)).Value = oRegistroEN.idTipoDeSalida;
                Comando.Parameters.Add(new MySqlParameter("@Nombre", MySqlDbType.VarChar, oRegistroEN.Nombre.Trim().Length)).Value = oRegistroEN.Nombre.Trim();
                Comando.Parameters.Add(new MySqlParameter("@Descripcion", MySqlDbType.VarChar, oRegistroEN.Descripcion.Trim().Length)).Value = oRegistroEN.Descripcion.Trim();                
                Comando.Parameters.Add(new MySqlParameter("@idUsuarioModificacion", MySqlDbType.Int32)).Value = oRegistroEN.idUsuarioModificacion;
        ...
        public bool Eliminar(TipoDeSalidaEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                Consultas = @"DELETE FROM tipodesalida WHERE idTipoDeSalida = @idTipoDeSalida;";
                Comando.CommandText = Consultas;
        ...
        public bool Listado(TipoDeSalidaEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                Consultas = string.Format(@"SELECT ts.idTipoDeSalida, ts.Nombre, ts.Descripcion, 
ts.idUsuarioDeCreacion, ts.FechaDeCreacion, u.Nombre as 'UsuarioDeCreacion',
ts.idUsuarioModificacion, ts.FechaDeModificacion, u1.Nombre as 'UsuarioDeModificacion'
FROM tipodesalida as ts
inner join usuario as u on u.idUsuario = ts.idUsuarioDeCreacion
left join usuario as u1 on u1.idUsuario = ts.idUsuarioModificacion
Where ts.idTipoDeSalida > 0 {0} {1} ", oRegistroEN.Where, oRegistroEN.OrderBy);
                Comando.CommandText = Consultas;
...
inner join usuario as u on u.idUsuario = ts.idUsuarioDeCreacion
left join usuario as u1 on u1.idUsuario = ts.idUsuarioModificacion
Where ts.idTipoDeSalida = {0} ", oRegistroEN.idTipoDeSalida);
                Comando.CommandText = Consultas;
        ...
        public bool ListadoParaCombos(TipoDeSalidaEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                Consultas = string.Format(@"SELECT ts.idTipoDeSalida, ts.Nombre
FROM tipodesalida as ts
Where ts.idTipoDeSalida > 0 {0} {1} ; ", oRegistroEN.Where, oRegistroEN.OrderBy);
                Comando.CommandText = Consultas;
...
Where ts.idTipoDeSalida > 0 {0} {1} ", oRegistroEN.Where, oRegistroEN.OrderBy);
        ...
        public bool ValidarSiElRegistroEstaVinculado(TipoDeSalidaEN oRegistroEN, DatosDeConexionEN oDatos, string TipoDeOperacion)
        {
            ...
            try
            {
                ...
                Comando.Parameters.Add(new MySqlParameter("@CampoABuscar_", MySqlDbType.VarChar, 200)).Value = "idTipoDeSalida";
                Comando.Parameters.Add(new MySqlParameter("@ValorCampoABuscar", MySqlDbType.Int32)).Value = oRegistroEN.idTipoDeSalida;
            ...
            try
            {
                ...
                switch (TipoDeOperacion.Trim().ToUpper()){
                    ...
                    case "AGREGAR":
                        ...
                        Consultas = @"SELECT CASE WHEN EXISTS(Select idTipoDeSalida from TipoDeSalida where upper( trim(Nombre) ) = upper(trim(@Nombre))) THEN 1 ELSE 0 END AS 'RES'";
                    ...
                    case "ACTUALIZAR":
                        ...
                        Consultas = @"SELECT CASE WHEN EXISTS(Select idTipoDeSalida from TipoDeSalida where upper( trim(Nombre) ) = upper(trim(@Nombre)) and idTipoDeSalida <> @idTipoDeSalida) THEN 1 ELSE 0 END AS 'RES'";
                        Comando.Parameters.Add(new MySqlParameter("@Nombre", MySqlDbType.VarChar, oRegistroEN.Nombre.Trim().Length)).Value = oRegistroEN.Nombre;
                        Comando.Parameters.Add(new MySqlParameter("@idTipoDeSalida", MySqlDbType.Int32)).Value = oRegistroEN.idTipoDeSalida;
        ...
        private TransaccionesEN InformacionDelaTransaccion(TipoDeSalidaEN oTipoDeSalida, String TipoDeOperacion, String Descripcion, String Estado)
        {
            TransaccionesEN oRegistroEN = new TransaccionesEN();

            oRegistroEN.idregistro = oTipoDeSalida.idTipoDeSalida;
            oRegistroEN.Modelo = "TipoDeSalidaAD";
            oRegistroEN.Modulo = "Transacciones";
            oRegistroEN.Tabla = "TipoDeSalida";
            oRegistroEN.tipodeoperacion = TipoDeOperacion;
            oRegistroEN.Estado = Estado;
            oRegistroEN.ip = oTipoDeSalida.oLoginEN.NumeroIP;
            oRegistroEN.idusuario = oTipoDeSalida.oLoginEN.idUsuario;
            oRegistroEN.idusuarioaprueba = oTipoDeSalida.oLoginEN.idUsuario;
            oRegistroEN.descripciondelusuario = DescripcionDeOperacion;
            oRegistroEN.descripcioninterna = Descripcion;
            oRegistroEN.NombreDelEquipo = oTipoDeSalida.oLoginEN.NombreDelComputador;

            return oRegistroEN;
        }


        private string InformacionDelRegistro(TipoDeSalidaEN oRegistroEN) {
            string Cadena = @"idTipoDeSalida: {0}, Nombre: {1}, Descripcion: {2}, idUsuarioDeCreacion: {3}, FechaDeCreacion: {4}, idUsuarioModificacion: {5}, FechaDeModificacion: {6}";
            Cadena = string.Format(Cadena, oRegistroEN.idTipoDeSalida, oRegistroEN.Nombre, oRegistroEN.Descripcion, oRegistroEN.idUsuarioDeCreacion, oRegistroEN.FechaDeCreacion, oRegistroEN.idUsuarioModificacion, oRegistroEN.FechaDeModificacion);
