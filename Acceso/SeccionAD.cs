    ...
    public class SeccionAD
    {
        ...
        public bool Listado(SeccionEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                Consultas = string.Format(@"Select idSeccion, s.Nombre, Descripcion, s.idUsuarioDeCreacion, 
        ...
        public bool ListadoParaCombos(SeccionEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                Consultas = string.Format(@"Select idSeccion, s.Nombre
                from Seccion as s                
                where idSeccion > 0  {0} {1} ; ", oRegistroEN.Where, oRegistroEN.OrderBy);
                Comando.CommandText = Consultas;
        ...
        private string InformacionDelRegistro(SeccionEN oRegistroEN) {
            string Cadena = @"idSeccion: {0}, Nombre: {1}, Descripcion: {2}, idUsuarioDeCreacion: {3}, FechaDeCreacion: {4}, idUsuarioModificacion: {5}, FechaDeModificacion: {6}";
            Cadena = string.Format(Cadena, oRegistroEN.idSeccion, oRegistroEN.Nombre, oRegistroEN.Descripcion, oRegistroEN.idUsuarioDeCreacion, oRegistroEN.FechaDeCreacion, oRegistroEN.idUsuarioModificacion, oRegistroEN.FechaDeModificacion);
