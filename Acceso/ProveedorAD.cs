    ...
    public class ProveedorAD
    {
        ...
        public bool Agregar(ProveedorEN oRegistroEN, DatosDeConexionEN oDatos) {
            ...
            try
            {
                ...
                Consultas = @"AgregarInformacionDelProveedor";

                Comando.CommandText = Consultas;

                Comando.Parameters.Add(new MySqlParameter("@idProveedor_", MySqlDbType.Int32)).Value = oRegistroEN.idProveedor;
        ...
        public bool Agregar(ProveedorEN oRegistroEN, DatosDeConexionEN oDatos, ref MySqlConnection Cnn_Existente, ref MySqlTransaction Transaccion_Existente)
        {
        ...
        public bool AgregarUtilizandoLaMismaConexion(ProveedorEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                oEntidadEN.oTipoDeEntidadEN.Nombre = "Proveedor";
                oEntidadEN.oTipoDeEntidadEN.NombreInterno = "proveedor";
                ...
                {
                    mensaje = String.Format("Error : '{1}', {0} producido al intentar guardar la información del proveedor. ", Environment.NewLine, this.Error);
                    throw new System.ArgumentException(mensaje);
                }
        ...
        public bool Actualizar(ProveedorEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                Consultas = @"UPDATE proveedor set 	               
                    Nombre = @Nombre, 
                    Direccion = @Direccion, 
                    NoRUC = @NoRUC, 
	                SitioWeb = @SitioWeb, 
                    Telefono = @Telefono, Movil = @Movil, 
                    Observaciones = @Observaciones, Correo = @Correo, 
                ...
                Comando.Parameters.Add(new MySqlParameter("@idProveedor", MySqlDbType.Int32)).Value = oRegistroEN.idProveedor;
        ...
        public bool Eliminar(ProveedorEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                Consultas = @"Delete from Proveedor Where idProveedor = @idProveedor;";
                Comando.CommandText = Consultas;
        ...
        public bool Listado(ProveedorEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                Consultas = string.Format(@"Select idProveedor, Codigo, p.Nombre, Direccion, NoRUC, 
                ...
                where p.idProveedor > 0 {0} {1} ", oRegistroEN.Where, oRegistroEN.OrderBy);
                Comando.CommandText = Consultas;
        ...
        public bool GenerarCodigoDelProveedor(ProveedorEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                Consultas = "Select GenerarCodigoDelProveedor() as 'Codigo';";
                Comando.CommandText = Consultas;
        ...
        public bool ListadoPorIdentificador(ProveedorEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                inner join usuario as  u on u.idUsuario = p.idUsuarioDeCreacion
                left join usuario as u1 on u1.idUsuario = p.idUsuarioModificacion 
                where p.idProveedor = {0} ", oRegistroEN.idProveedor);
                Comando.CommandText = Consultas;
        ...
        public bool ListadoParaCombos(ProveedorEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                Consultas = string.Format(@"Select idProveedor, concat(Codigo, ' - ', Nombre) as 'NombreDelProveedor' from proveedor as p
                where p.idProveedor > 0 {0} {1} ; ", oRegistroEN.Where, oRegistroEN.OrderBy);
                Comando.CommandText = Consultas;
        ...
        public bool ValidarSiElRegistroEstaVinculado(ProveedorEN oRegistroEN, DatosDeConexionEN oDatos, string TipoDeOperacion)
        {
            ...
            try
            {
                ...
                Comando.Parameters.Add(new MySqlParameter("@CampoABuscar_", MySqlDbType.VarChar, 200)).Value = "idProveedor";
                Comando.Parameters.Add(new MySqlParameter("@ValorCampoABuscar", MySqlDbType.Int32)).Value = oRegistroEN.idProveedor;
                Comando.Parameters.Add(new MySqlParameter("@ExcluirTabla_", MySqlDbType.VarChar, 200)).Value = "'Entidad','proveedorcontacto', 'ProveedorLaboratorio'";
            ...
            try
            {
                ...
                switch (TipoDeOperacion.Trim().ToUpper()){
                    ...
                    case "AGREGAR":
                        ...
                        Consultas = @"SELECT CASE WHEN EXISTS(Select idProveedor from Proveedor where upper( trim(Nombre) ) = upper(trim(@Nombre))) THEN 1 ELSE 0 END AS 'RES'";
                    ...
                    case "ACTUALIZAR":
                        ...
                        Consultas = @"SELECT CASE WHEN EXISTS(Select idProveedor from Proveedor where upper( trim(Nombre) ) = upper(trim(@Nombre)) and idProveedor <> @idProveedor) THEN 1 ELSE 0 END AS 'RES'";
                        Comando.Parameters.Add(new MySqlParameter("@Nombre", MySqlDbType.VarChar, oRegistroEN.Nombre.Trim().Length)).Value = oRegistroEN.Nombre;
                        Comando.Parameters.Add(new MySqlParameter("@idProveedor", MySqlDbType.Int32)).Value = oRegistroEN.idProveedor;
        ...
        private TransaccionesEN InformacionDelaTransaccion(ProveedorEN oProveedor, String TipoDeOperacion, String Descripcion, String Estado)
        {
            TransaccionesEN oRegistroEN = new TransaccionesEN();

            oRegistroEN.idregistro = oProveedor.idProveedor;
            oRegistroEN.Modelo = "Proveedor";
            oRegistroEN.Modulo = "General";
            oRegistroEN.Tabla = "Proveedor";
            oRegistroEN.tipodeoperacion = TipoDeOperacion;
            oRegistroEN.Estado = Estado;
            oRegistroEN.ip = oProveedor.oLoginEN.NumeroIP;
            oRegistroEN.idusuario = oProveedor.oLoginEN.idUsuario;
            oRegistroEN.idusuarioaprueba = oProveedor.oLoginEN.idUsuario;
            oRegistroEN.descripciondelusuario = DescripcionDeOperacion;
            oRegistroEN.descripcioninterna = Descripcion;
            oRegistroEN.NombreDelEquipo = oProveedor.oLoginEN.NombreDelComputador;
            
            return oRegistroEN;
        }


        private string InformacionDelRegistro(ProveedorEN oRegistroEN) {
            string Cadena = @"idProveedor: {0}, Codigo: {1}, Nombre: {2}, Direccion: {3}, NoRUC: {4}, 
            ...
            Cadena = string.Format(Cadena, oRegistroEN.idProveedor, oRegistroEN.Codigo,oRegistroEN.Nombre, oRegistroEN.Direccion,
