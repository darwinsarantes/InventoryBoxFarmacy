...
{
    public class TipoDeUbicacionAD
    {
        ...
        public bool Agregar(TipoDeUbicacionEN oRegistroEN, DatosDeConexionEN oDatos) {
            ...
            try
            {
                ...
                oRegistroEN.idTipoDeUbicacion = Convert.ToInt32(DT.Rows[0].ItemArray[0].ToString());
        ...
        public bool Actualizar(TipoDeUbicacionEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                Consultas = @"update tipodeubicacion set

	                Nombre = @Nombre, Descripcion = @Descripcion, 
	                idUsuarioModificacion = @idUsuarioModificacion, 
                    FechaDeModificacion = current_timestamp()

                where idTipoDeUbicacion = @idTipoDeUbicacion;";

                Comando.CommandText = Consultas;

                Comando.Parameters.Add(new MySqlParameter("@idTipoDeUbicacion", MySqlDbType.Int32)).Value = oRegistroEN.idTipoDeUbicacion;
                Comando.Parameters.Add(new MySqlParameter("@Nombre", MySqlDbType.VarChar, oRegistroEN.Nombre.Trim().Length)).Value = oRegistroEN.Nombre.Trim();
                Comando.Parameters.Add(new MySqlParameter("@Descripcion", MySqlDbType.VarChar, oRegistroEN.Descripcion.Trim().Length)).Value = oRegistroEN.Descripcion.Trim();                
                Comando.Parameters.Add(new MySqlParameter("@idUsuarioModificacion", MySqlDbType.Int32)).Value = oRegistroEN.idUsuarioModificacion;
        ...
        public bool Eliminar(TipoDeUbicacionEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                Consultas = @"Delete from TipoDeUbicacion Where idTipoDeUbicacion = @idTipoDeUbicacion;";
                Comando.CommandText = Consultas;
        ...
        public bool Listado(TipoDeUbicacionEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                Consultas = string.Format(@"Select idTipoDeUbicacion, tu.Nombre, tu.Descripcion, 
tu.idUsuarioDeCreacion, tu.FechaDeCreacion, u.Nombre as 'UsuarioDeCreacion',
tu.idUsuarioModificacion,tu.FechaDeModificacion, u1.Nombre as 'UsuarioDeModificacion'
from tipodeubicacion tu
inner join usuario as u on u.idUsuario = tu.idUsuarioDeCreacion
left join usuario as u1 on u1.idUsuario = tu.idUsuarioModificacion
Where idTipoDeUbicacion > 0 {0} {1} ", oRegistroEN.Where, oRegistroEN.OrderBy);
                Comando.CommandText = Consultas;
...
inner join usuario as u on u.idUsuario = tu.idUsuarioDeCreacion
left join usuario as u1 on u1.idUsuario = tu.idUsuarioModificacion
Where idTipoDeUbicacion  = {0} ", oRegistroEN.idTipoDeUbicacion);
                Comando.CommandText = Consultas;
        ...
        public bool ListadoParaCombos(TipoDeUbicacionEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                Consultas = string.Format(@"Select idTipoDeUbicacion, tu.Nombre
from tipodeubicacion tu
Where idTipoDeUbicacion > 0 {0} {1} ; ", oRegistroEN.Where, oRegistroEN.OrderBy);
                Comando.CommandText = Consultas;
...
Where idTipoDeUbicacion > 0 {0} {1} ", oRegistroEN.Where, oRegistroEN.OrderBy);
        ...
        public bool ValidarSiElRegistroEstaVinculado(TipoDeUbicacionEN oRegistroEN, DatosDeConexionEN oDatos, string TipoDeOperacion)
        {
            ...
            try
            {
                ...
                Comando.Parameters.Add(new MySqlParameter("@CampoABuscar_", MySqlDbType.VarChar, 200)).Value = "idTipoDeUbicacion";
                Comando.Parameters.Add(new MySqlParameter("@ValorCampoABuscar", MySqlDbType.Int32)).Value = oRegistroEN.idTipoDeUbicacion;
            ...
            try
            {
                ...
                switch (TipoDeOperacion.Trim().ToUpper()){
                    ...
                    case "AGREGAR":
                        ...
                        Consultas = @"SELECT CASE WHEN EXISTS(Select idTipoDeUbicacion from TipoDeUbicacion where upper( trim(Nombre) ) = upper(trim(@Nombre))) THEN 1 ELSE 0 END AS 'RES'";
                    ...
                    case "ACTUALIZAR":
                        ...
                        Consultas = @"SELECT CASE WHEN EXISTS(Select idTipoDeUbicacion from TipoDeUbicacion where upper( trim(Nombre) ) = upper(trim(@Nombre)) and idTipoDeUbicacion <> @idTipoDeUbicacion) THEN 1 ELSE 0 END AS 'RES'";
                        Comando.Parameters.Add(new MySqlParameter("@Nombre", MySqlDbType.VarChar, oRegistroEN.Nombre.Trim().Length)).Value = oRegistroEN.Nombre;
                        Comando.Parameters.Add(new MySqlParameter("@idTipoDeUbicacion", MySqlDbType.Int32)).Value = oRegistroEN.idTipoDeUbicacion;
        ...
        private TransaccionesEN InformacionDelaTransaccion(TipoDeUbicacionEN oTipoDeUbicacion, String TipoDeOperacion, String Descripcion, String Estado)
        {
            TransaccionesEN oRegistroEN = new TransaccionesEN();

            oRegistroEN.idregistro = oTipoDeUbicacion.idTipoDeUbicacion;
            oRegistroEN.Modelo = "TransaccionAD";
            oRegistroEN.Modulo = "Transacciones";
            oRegistroEN.Tabla = "TipoDeUbicacions";
            oRegistroEN.tipodeoperacion = TipoDeOperacion;
            oRegistroEN.Estado = Estado;
            oRegistroEN.ip = oTipoDeUbicacion.oLoginEN.NumeroIP;
            oRegistroEN.idusuario = oTipoDeUbicacion.oLoginEN.idUsuario;
            oRegistroEN.idusuarioaprueba = oTipoDeUbicacion.oLoginEN.idUsuario;
            oRegistroEN.descripciondelusuario = DescripcionDeOperacion;
            oRegistroEN.descripcioninterna = Descripcion;
            oRegistroEN.NombreDelEquipo = oTipoDeUbicacion.oLoginEN.NombreDelComputador;

            return oRegistroEN;
        }


        private string InformacionDelRegistro(TipoDeUbicacionEN oRegistroEN) {
            string Cadena = @"idTipoDeUbicacion: {0}, Nombre: {1}, Descripción: {2},dUsuarioDeCreacion: {3}, FechaDeCreacion: {4}, idUsuarioModificacion: {5}, FechaDeModificacion: {6}";
            Cadena = string.Format(Cadena, oRegistroEN.idTipoDeUbicacion, oRegistroEN.Nombre, oRegistroEN.Descripcion, oRegistroEN.idUsuarioDeCreacion, oRegistroEN.FechaDeCreacion, oRegistroEN.idUsuarioModificacion, oRegistroEN.FechaDeModificacion);
