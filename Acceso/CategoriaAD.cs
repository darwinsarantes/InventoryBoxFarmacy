    ...
    public class CategoriaAD
    {
        ...
        public bool Agregar(CategoriaEN oRegistroEN, DatosDeConexionEN oDatos) {
            ...
            try
            {
                ...
                oRegistroEN.idCategoria = Convert.ToInt32(DT.Rows[0].ItemArray[0].ToString());
        ...
        public bool Actualizar(CategoriaEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                Consultas = @"update Categoria set
        ...
        public bool Listado(CategoriaEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                Consultas = string.Format(@"Select idCategoria, ub.Nombre, Descripcion, ub.idUsuarioDeCreacion, 
                ub.FechaDeCreacion, ub.idUsuarioModificacion, ub.FechaDeModificacion 
                from Categoria as ub
                inner join usuario as u on u.idUsuario = ub.idUsuarioDeCreacion
                left join usuario as u1 on u1.idUsuario = ub.idUsuarioModificacion
                where idCategoria > 0  {0} {1} ", oRegistroEN.Where, oRegistroEN.OrderBy);
                Comando.CommandText = Consultas;
        ...
        public bool ListadoPorIdentificador(CategoriaEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                inner join usuario as u on u.idUsuario = ub.idUsuarioDeCreacion
                left join usuario as u1 on u1.idUsuario = ub.idUsuarioModificacion
                where idCategoria = {0} ", oRegistroEN.idCategoria);
                Comando.CommandText = Consultas;
        ...
        public bool ListadoParaCombos(CategoriaEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                Consultas = string.Format(@"Select idCategoria, ub.Nombre
                from Categoria as ub                
                where idCategoria > 0  {0} {1} ; ", oRegistroEN.Where, oRegistroEN.OrderBy);
                Comando.CommandText = Consultas;
        ...
        public bool ValidarSiElRegistroEstaVinculado(CategoriaEN oRegistroEN, DatosDeConexionEN oDatos, string TipoDeOperacion)
        {
            ...
            try
            {
                ...
                Comando.Parameters.Add(new MySqlParameter("@CampoABuscar_", MySqlDbType.VarChar, 200)).Value = "idCategoria";
                Comando.Parameters.Add(new MySqlParameter("@ValorCampoABuscar", MySqlDbType.Int32)).Value = oRegistroEN.idCategoria;
            ...
            try
            {
                ...
                switch (TipoDeOperacion.Trim().ToUpper()){
                    ...
                    case "AGREGAR":
                        ...
                        Consultas = @"SELECT CASE WHEN EXISTS(Select idCategoria from Categoria where upper( trim(Nombre) ) = upper(trim(@Nombre))) THEN 1 ELSE 0 END AS 'RES'";
                    ...
                    case "ACTUALIZAR":
                        ...
                        Consultas = @"SELECT CASE WHEN EXISTS(Select idCategoria from Categoria where upper( trim(Nombre) ) = upper(trim(@Nombre)) and idCategoria <> @idCategoria) THEN 1 ELSE 0 END AS 'RES'";
                        Comando.Parameters.Add(new MySqlParameter("@Nombre", MySqlDbType.VarChar, oRegistroEN.Nombre.Trim().Length)).Value = oRegistroEN.Nombre;
                        Comando.Parameters.Add(new MySqlParameter("@idCategoria", MySqlDbType.Int32)).Value = oRegistroEN.idCategoria;
        ...
        private TransaccionesEN InformacionDelaTransaccion(CategoriaEN oCategoria, String TipoDeOperacion, String Descripcion, String Estado)
        {
            TransaccionesEN oRegistroEN = new TransaccionesEN();

            oRegistroEN.idregistro = oCategoria.idCategoria;
            oRegistroEN.Modelo = "General";
            oRegistroEN.Modulo = "CategoriaAD";
            oRegistroEN.Tabla = "Categoria";
            oRegistroEN.tipodeoperacion = TipoDeOperacion;
            oRegistroEN.Estado = Estado;
            oRegistroEN.ip = oCategoria.oLoginEN.NumeroIP;
            oRegistroEN.idusuario = oCategoria.oLoginEN.idUsuario;
            oRegistroEN.idusuarioaprueba = oCategoria.oLoginEN.idUsuario;
            oRegistroEN.descripciondelusuario = DescripcionDeOperacion;
            oRegistroEN.descripcioninterna = Descripcion;
            oRegistroEN.NombreDelEquipo = oCategoria.oLoginEN.NombreDelComputador;
