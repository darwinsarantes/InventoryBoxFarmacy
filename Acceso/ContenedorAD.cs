    ...
    public class ContenedorAD
    {
        ...
        public bool Agregar(ContenedorEN oRegistroEN, DatosDeConexionEN oDatos) {
            ...
            try
            {
                ...
                (idContenedor,Codigo,Nombre, Descripcion, 
        ...
        public bool Agregar(ContenedorEN oRegistroEN, DatosDeConexionEN oDatos, ref MySqlConnection Cnn_Existente, ref MySqlTransaction Transaccion_Existente)
        {
        ...
        public bool AgregarUtilizandoLaMismaConexion(ContenedorEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                oEntidadEN.oTipoDeEntidadEN.Nombre = "Contenedor";
                oEntidadEN.oTipoDeEntidadEN.NombreInterno = "Contenedor";
                ...
                {
                    oRegistroEN.idContenedor = oEntidadEN.idEntidad;
                ...
                {
                    mensaje = String.Format("Error : '{1}', {0} producido al intentar guardar la información de la Contenedor. ", Environment.NewLine, this.Error);
                    throw new System.ArgumentException(mensaje);
                }
        ...
        public bool Eliminar(ContenedorEN oRegistroEN, DatosDeConexionEN oDatos, ref MySqlConnection Cnn_Existente, ref MySqlTransaction Transaccion_Existente)
        {
            oTransaccionesAD = new TransaccionesAD();
        ...
        public bool EliminarUtilizandoLaMismaConexion(ContenedorEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                //Debemos agrear la Entidad Correspondiente
                EntidadEN oEntidadEN = new EntidadEN();
                oEntidadEN.idEntidad = oRegistroEN.idContenedor;
                oEntidadEN.oTipoDeEntidadEN.Nombre = "Contenedor";
                oEntidadEN.oTipoDeEntidadEN.NombreInterno = "Contenedor";
                oEntidadEN.oLoginEN = oRegistroEN.oLoginEN;
                oEntidadEN.IdUsuarioDeCreacion = oRegistroEN.oLoginEN.idUsuario;
                ...
                {
                    mensaje = String.Format("Error : '{1}', {0} producido al intentar eliminar la información del contenedor de productos. ", Environment.NewLine, this.Error);
                    throw new System.ArgumentException(mensaje);
                }
                ...
                {
                    mensaje = String.Format("Error : '{1}', {0} producido al intentar eliminar la información de la entidad superior. ", Environment.NewLine, oEntidadAD.Error);
                    throw new System.ArgumentException(mensaje);
                }
        ...
        public bool Listado(ContenedorEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                Consultas = string.Format(@"Select idContenedor,cr.Codigo, cr.Nombre, Descripcion, cr.idUsuarioDeCreacion, 
                cr.FechaDeCreacion, cr.idUsuarioModificacion, cr.FechaDeModificacion 
                from Contenedor as cr
                inner join usuario as u on u.idUsuario = cr.idUsuarioDeCreacion
                left join usuario as u1 on u1.idUsuario = cr.idUsuarioModificacion
        ...
        public bool ListadoPorIdentificador(ContenedorEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                inner join usuario as u on u.idUsuario = cr.idUsuarioDeCreacion
                left join usuario as u1 on u1.idUsuario = cr.idUsuarioModificacion
                where idContenedor = {0} ", oRegistroEN.idContenedor);
                Comando.CommandText = Consultas;
            ...
            try
            {
                ...
                switch (TipoDeOperacion.Trim().ToUpper()){
                    ...
                    case "AGREGAR":
                        ...
                        Consultas = @"SELECT CASE WHEN EXISTS(Select idContenedor from Contenedor where upper( trim(Nombre) ) = upper(trim(@Nombre))) THEN 1 ELSE 0 END AS 'RES'";
                    ...
                    case "ACTUALIZAR":
                        ...
                        Consultas = @"SELECT CASE WHEN EXISTS(Select idContenedor from Contenedor where upper( trim(Nombre) ) = upper(trim(@Nombre)) and idContenedor <> @idContenedor) THEN 1 ELSE 0 END AS 'RES'";
                        Comando.Parameters.Add(new MySqlParameter("@Nombre", MySqlDbType.VarChar, oRegistroEN.Nombre.Trim().Length)).Value = oRegistroEN.Nombre;
                        Comando.Parameters.Add(new MySqlParameter("@idContenedor", MySqlDbType.Int32)).Value = oRegistroEN.idContenedor;
            ...
            try
            {
                ...
                switch (TipoDeOperacion.Trim().ToUpper())
                {
                    ...
                    case "AGREGAR":
                        ...
                        Consultas = @"SELECT CASE WHEN EXISTS(Select idContenedor from Contenedor where upper( trim(Codigo) ) = upper(trim(@Codigo))) THEN 1 ELSE 0 END AS 'RES'";
                    ...
                    case "ACTUALIZAR":
                        ...
                        Consultas = @"SELECT CASE WHEN EXISTS(Select idContenedor from Contenedor where upper( trim(Codigo) ) = upper(trim(@Codigo)) and idContenedor <> @idContenedor) THEN 1 ELSE 0 END AS 'RES'";
                        Comando.Parameters.Add(new MySqlParameter("@Codigo", MySqlDbType.VarChar, oRegistroEN.Codigo.Trim().Length)).Value = oRegistroEN.Codigo;
                        Comando.Parameters.Add(new MySqlParameter("@idContenedor", MySqlDbType.Int32)).Value = oRegistroEN.idContenedor;
