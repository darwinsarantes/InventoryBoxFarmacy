    ...
    public class BancosAD
    {
        ...
        public bool Agregar(BancosEN oRegistroEN, DatosDeConexionEN oDatos) {
            ...
            try
            {
                ...
                oRegistroEN.idBancos = Convert.ToInt32(DT.Rows[0].ItemArray[0].ToString());
        ...
        public bool Actualizar(BancosEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                Comando.Parameters.Add(new MySqlParameter("@idBancos", MySqlDbType.Int32)).Value = oRegistroEN.idBancos;
                Comando.Parameters.Add(new MySqlParameter("@Nombre", MySqlDbType.VarChar, oRegistroEN.Nombre.Trim().Length)).Value = oRegistroEN.Nombre.Trim();
                Comando.Parameters.Add(new MySqlParameter("@Descripcion", MySqlDbType.VarChar, oRegistroEN.Descripcion.Trim().Length)).Value = oRegistroEN.Descripcion.Trim();                
                Comando.Parameters.Add(new MySqlParameter("@idUsuarioModificacion", MySqlDbType.Int32)).Value = oRegistroEN.idUsuarioModificacion;
        ...
        public bool Eliminar(BancosEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                Consultas = @"DELETE FROM Bancos where idBancos = @idBancos;";
                Comando.CommandText = Consultas;
        ...
        public bool Listado(BancosEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                Consultas = string.Format(@"SELECT bn.idBancos, bn.Nombre, bn.Descripcion, 
                bn.idUsuarioDeCreacion, bn.FechaDeCreacion, u.Nombre as 'UsuarioDeCreacion',
                bn.idUsuarioModificacion, bn.FechaDeModificacion , u1.Nombre as 'UsuarioDeModificacion'
                FROM bancos AS bn
                inner join usuario as u on u.idUsuario = bn.idUsuarioDeCreacion
                left join usuario as u1 on u1.idUsuario = bn.idUsuarioModificacion
                Where bn.idBancos > 0 {0} {1} ", oRegistroEN.Where, oRegistroEN.OrderBy);
                Comando.CommandText = Consultas;
        ...
        public bool ListadoPorIdentificador(BancosEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                Consultas = string.Format(@"Select te.idBancos, te.Nombre, te.Descripcion, 
                te.idUsuarioDeCreacion, te.FechaDeCreacion, u.Nombre as 'UsuarioDeCreacion',
                te.idUsuarioModificacion, te.FechaDeModificacion, u1.Nombre as 'UsuarioDeModificacion'
                from Bancos as te 
                inner join usuario as u on u.idUsuario = te.idUsuarioDeCreacion
                left join usuario as u1 on u1.idUsuario = te.idUsuarioModificacion
                Where te.idBancos = {0} ", oRegistroEN.idBancos);
                Comando.CommandText = Consultas;
        ...
        public bool ListadoParaCombos(BancosEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                Consultas = string.Format(@"Select te.idBancos, te.Nombre
                from Bancos as te 
                Where te.idBancos > 0 {0} {1} ; ", oRegistroEN.Where, oRegistroEN.OrderBy);
                Comando.CommandText = Consultas;
        ...
        public bool ValidarSiElRegistroEstaVinculado(BancosEN oRegistroEN, DatosDeConexionEN oDatos, string TipoDeOperacion)
        {
            ...
            try
            {
                ...
                Comando.Parameters.Add(new MySqlParameter("@CampoABuscar_", MySqlDbType.VarChar, 200)).Value = "idBancos";
                Comando.Parameters.Add(new MySqlParameter("@ValorCampoABuscar", MySqlDbType.Int32)).Value = oRegistroEN.idBancos;
            ...
            try
            {
                ...
                switch (TipoDeOperacion.Trim().ToUpper()){
                    ...
                    case "AGREGAR":
                        ...
                        Consultas = @"SELECT CASE WHEN EXISTS(Select idBancos from Bancos where upper( trim(Nombre) ) = upper(trim(@Nombre))) THEN 1 ELSE 0 END AS 'RES'";
                    ...
                    case "ACTUALIZAR":
                        ...
                        Consultas = @"SELECT CASE WHEN EXISTS(Select idBancos from Bancos where upper( trim(Nombre) ) = upper(trim(@Nombre)) and idBancos <> @idBancos) THEN 1 ELSE 0 END AS 'RES'";
                        Comando.Parameters.Add(new MySqlParameter("@Nombre", MySqlDbType.VarChar, oRegistroEN.Nombre.Trim().Length)).Value = oRegistroEN.Nombre;
                        Comando.Parameters.Add(new MySqlParameter("@idBancos", MySqlDbType.Int32)).Value = oRegistroEN.idBancos;
        ...
        private TransaccionesEN InformacionDelaTransaccion(BancosEN oBancos, String TipoDeOperacion, String Descripcion, String Estado)
        {
            TransaccionesEN oRegistroEN = new TransaccionesEN();

            oRegistroEN.idregistro = oBancos.idBancos;
            oRegistroEN.Modelo = "BancosAD";
            oRegistroEN.Modulo = "Transacciones";
            oRegistroEN.Tabla = "Bancos";
            oRegistroEN.tipodeoperacion = TipoDeOperacion;
            oRegistroEN.Estado = Estado;
            oRegistroEN.ip = oBancos.oLoginEN.NumeroIP;
            oRegistroEN.idusuario = oBancos.oLoginEN.idUsuario;
            oRegistroEN.idusuarioaprueba = oBancos.oLoginEN.idUsuario;
            oRegistroEN.descripciondelusuario = DescripcionDeOperacion;
            oRegistroEN.descripcioninterna = Descripcion;
            oRegistroEN.NombreDelEquipo = oBancos.oLoginEN.NombreDelComputador;

            return oRegistroEN;
        }


        private string InformacionDelRegistro(BancosEN oRegistroEN) {
            string Cadena = @"idBancos: {0}, Nombre: {1}, Descripcion: {2}, idUsuarioDeCreacion: {3}, FechaDeCreacion: {4}, idUsuarioModificacion: {5}, FechaDeModificacion: {6}";
            Cadena = string.Format(Cadena, oRegistroEN.idBancos, oRegistroEN.Nombre, oRegistroEN.Descripcion, oRegistroEN.idUsuarioDeCreacion, oRegistroEN.FechaDeCreacion, oRegistroEN.idUsuarioModificacion, oRegistroEN.FechaDeModificacion);
