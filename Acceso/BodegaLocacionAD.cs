    ...
    public class BodegaLocacionAD
    {
        ...
        public bool Agregar(BodegaLocacionEN oRegistroEN, DatosDeConexionEN oDatos) {
            ...
            try
            {
                ...
                oRegistroEN.idBodegaLocacion = Convert.ToInt32(DT.Rows[0].ItemArray[0].ToString());
        ...
        public bool Actualizar(BodegaLocacionEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                Consultas = @"UPDATE bodegalocacion SET
	                idBodega = @idBodega, idLocacion = @idLocacion, 	
	                idUsuarioModificacion = @idUsuarioModificacion, FechaDeModificacion = current_timestamp()
                WHERE idBodegaLocacion = @idBodegaLocacion ;";

                Comando.CommandText = Consultas;

                Comando.Parameters.Add(new MySqlParameter("@idBodegaLocacion", MySqlDbType.Int32)).Value = oRegistroEN.idBodegaLocacion;
                Comando.Parameters.Add(new MySqlParameter("@idBodega", MySqlDbType.Int32)).Value = oRegistroEN.oBodegaEN.idBodega;
                Comando.Parameters.Add(new MySqlParameter("@idLocacion", MySqlDbType.Int32)).Value = oRegistroEN.oLocacionEN.idLocacion;                
                Comando.Parameters.Add(new MySqlParameter("@idUsuarioModificacion", MySqlDbType.Int32)).Value = oRegistroEN.idUsuarioModificacion;
        ...
        public bool Eliminar(BodegaLocacionEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                Consultas = @"Delete from BodegaLocacion Where idBodegaLocacion = @idBodegaLocacion;";
                Comando.CommandText = Consultas;
        ...
        public bool Listado(BodegaLocacionEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                Consultas = string.Format(@"Select bl.idBodegaLocacion, bl.idBodega, bl.idLocacion, 
                lc.Codigo as 'CodigoLocacion', lc.Nombre as 'Locacion', lc.Descripcion as 'DescLocacion',
                bg.Codigo as 'CodigoBodega', bg.Nombre as 'Bodega', bg.Descripcion as 'DescBodega', 
                bl.idUsuarioDeCreacion, bl.FechaDeCreacion, 
                bl.idUsuarioModificacion, bl.FechaDeModificacion 
                from bodegalocacion as bl
                inner join bodega as bg on bg.idBodega = bl.idBodega
                inner join locacion as lc on lc.idLocacion = bl.idLocacion
                Where bl.idBodegaLocacion > 0 {0} {1} ", oRegistroEN.Where, oRegistroEN.OrderBy);
                Comando.CommandText = Consultas;
        ...
        public bool ListadoDeLocacionesPorBodega(BodegaLocacionEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                inner join bodega as bg on bg.idBodega = bl.idBodega
                inner join locacion as lc on lc.idLocacion = bl.idLocacion
                Where bl.idBodegaLocacion > 0 and bl.idBodega = {0} ", oRegistroEN.oBodegaEN.idBodega);
                Comando.CommandText = Consultas;
        ...
        public bool ListadoDeBodegasPorLocacion(BodegaLocacionEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                Consultas = string.Format(@"Select bl.idBodegaLocacion, bl.idBodega, bl.idLocacion, 
                bg.Codigo, bg.Nombre, bg.Descripcion,
                bl.idUsuarioDeCreacion, bl.FechaDeCreacion, 
                bl.idUsuarioModificacion, bl.FechaDeModificacion 
                from bodegalocacion as bl
                inner join bodega as bg on bg.idBodega = bl.idBodega
                inner join locacion as lc on lc.idLocacion = bl.idLocacion
                Where bl.idBodegaLocacion > 0 and bl.idLocacion = {0} ", oRegistroEN.oLocacionEN.idLocacion);
                Comando.CommandText = Consultas;
        ...
        public bool ListadoPorIdentificador(BodegaLocacionEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                inner join bodega as bg on bg.idBodega = bl.idBodega
                inner join locacion as lc on lc.idLocacion = bl.idLocacion
                Where bl.idBodegaLocacion = {0} ", oRegistroEN.idBodegaLocacion);
                Comando.CommandText = Consultas;
        ...
        public bool ValidarSiElRegistroEstaVinculado(BodegaLocacionEN oRegistroEN, DatosDeConexionEN oDatos, string TipoDeOperacion)
        {
            ...
            try
            {
                ...
                Comando.Parameters.Add(new MySqlParameter("@CampoABuscar_", MySqlDbType.VarChar, 200)).Value = "idBodegaLocacion";
                Comando.Parameters.Add(new MySqlParameter("@ValorCampoABuscar", MySqlDbType.Int32)).Value = oRegistroEN.idBodegaLocacion;
            ...
            try
            {
                ...
                switch (TipoDeOperacion.Trim().ToUpper()){
                    ...
                    case "AGREGAR":
                        ...
                        Consultas = @"SELECT CASE WHEN EXISTS(Select idBodegaLocacion from almacenubicacion Where idBodega = @idBodega and idLocacion = @idLocacion) THEN 1 ELSE 0 END AS 'RES'";
                        Comando.Parameters.Add(new MySqlParameter("@idBodega", MySqlDbType.Int32)).Value = oRegistroEN.oBodegaEN.idBodega;
                        Comando.Parameters.Add(new MySqlParameter("@idLocacion", MySqlDbType.Int32)).Value = oRegistroEN.oLocacionEN.idLocacion;
                    ...
                    case "ACTUALIZAR":
                        ...
                        Consultas = @"SELECT CASE WHEN EXISTS(Select idBodegaLocacion from almacenubicacion Where idBodega = @idBodega and idLocacion = @idLocacion and idBodegaLocacion <> @idBodegaLocacion) THEN 1 ELSE 0 END AS 'RES'";
                        Comando.Parameters.Add(new MySqlParameter("@idBodega", MySqlDbType.Int32)).Value = oRegistroEN.oBodegaEN.idBodega;
                        Comando.Parameters.Add(new MySqlParameter("@idLocacion", MySqlDbType.Int32)).Value = oRegistroEN.oLocacionEN.idLocacion;
                        Comando.Parameters.Add(new MySqlParameter("@idBodegaLocacion", MySqlDbType.Int32)).Value = oRegistroEN.idBodegaLocacion;
        ...
        private TransaccionesEN InformacionDelaTransaccion(BodegaLocacionEN oBodegaLocacion, String TipoDeOperacion, String Descripcion, String Estado)
        {
            TransaccionesEN oRegistroEN = new TransaccionesEN();

            oRegistroEN.idregistro = oBodegaLocacion.idBodegaLocacion;
            oRegistroEN.Modelo = "BodegaLocacionsAD";
            oRegistroEN.Modulo = "Ubicacion";
            oRegistroEN.Tabla = "BodegaLocacion";
            oRegistroEN.tipodeoperacion = TipoDeOperacion;
            oRegistroEN.Estado = Estado;
            oRegistroEN.ip = oBodegaLocacion.oLoginEN.NumeroIP;
            oRegistroEN.idusuario = oBodegaLocacion.oLoginEN.idUsuario;
            oRegistroEN.idusuarioaprueba = oBodegaLocacion.oLoginEN.idUsuario;
            oRegistroEN.descripciondelusuario = DescripcionDeOperacion;
            oRegistroEN.descripcioninterna = Descripcion;
            oRegistroEN.NombreDelEquipo = oBodegaLocacion.oLoginEN.NombreDelComputador;

            return oRegistroEN;
        }


        private string InformacionDelRegistro(BodegaLocacionEN oRegistroEN) {
            string Cadena = @"idBodegaLocacion: {0}, idBodega: {1}, idLocacion: {2}";
            Cadena = string.Format(Cadena, oRegistroEN.idBodegaLocacion, oRegistroEN.oBodegaEN.idBodega, oRegistroEN.oLocacionEN.idLocacion);
