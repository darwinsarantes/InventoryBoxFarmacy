...
{
    public class ProductoPresentacionAD
    {
        ...
        public bool Agregar(ProductoPresentacionEN oRegistroEN, DatosDeConexionEN oDatos) {
            ...
            try
            {
                ...
                oRegistroEN.idProductoPresentacion = Convert.ToInt32(DT.Rows[0].ItemArray[0].ToString());
        ...
        public bool Actualizar(ProductoPresentacionEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                Consultas = @"update productopresentacion set
                ...
                Comando.Parameters.Add(new MySqlParameter("@idProductoPresentacion", MySqlDbType.Int32)).Value = oRegistroEN.idProductoPresentacion;
                Comando.Parameters.Add(new MySqlParameter("@Nombre", MySqlDbType.VarChar, oRegistroEN.Nombre.Trim().Length)).Value = oRegistroEN.Nombre.Trim();
                Comando.Parameters.Add(new MySqlParameter("@Descripcion", MySqlDbType.VarChar, oRegistroEN.Descripcion.Trim().Length)).Value = oRegistroEN.Descripcion.Trim();
                Comando.Parameters.Add(new MySqlParameter("@Abreviatura", MySqlDbType.VarChar, oRegistroEN.Abreviatura.Trim().Length)).Value = oRegistroEN.Abreviatura.Trim();                
                Comando.Parameters.Add(new MySqlParameter("@idUsuarioModificacion", MySqlDbType.Int32)).Value = oRegistroEN.oLoginEN.idUsuario;
        ...
        public bool Eliminar(ProductoPresentacionEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                Consultas = @"Delete from ProductoPresentacion Where idProductoPresentacion = @idProductoPresentacion;";
                Comando.CommandText = Consultas;
        ...
        public bool Listado(ProductoPresentacionEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                Consultas = string.Format(@"Select idProductoPresentacion, pps.Nombre, pps.Abreviatura, pps.Descripcion,
                pps.idUsuarioDeCreacion, pps.FechaDeCreacion, u.Nombre as 'UsuarioDeCreacion',
                pps.idUsuarioModificacion, pps.FechaDeModificacion , u1.Nombre as 'UsuarioDeModificacion'
                from productopresentacion as pps
                inner join usuario as u on u.idUsuario = pps.idUsuarioDeCreacion
                left join usuario as u1 on u1.idUsuario = pps.idUsuarioModificacion
                Where idProductoPresentacion > 0  {0} {1} ", oRegistroEN.Where, oRegistroEN.OrderBy);
                Comando.CommandText = Consultas;
        ...
        public bool ListadoPorIdentificador(ProductoPresentacionEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                inner join usuario as u on u.idUsuario = pps.idUsuarioDeCreacion
                left join usuario as u1 on u1.idUsuario = pps.idUsuarioModificacion
                Where idProductoPresentacion ={0} ", oRegistroEN.idProductoPresentacion);
                Comando.CommandText = Consultas;
        ...
        public bool ListadoParaCombos(ProductoPresentacionEN oRegistroEN, DatosDeConexionEN oDatos)
        {
            ...
            try
            {
                ...
                Consultas = string.Format(@"Select idProductoPresentacion, pps.Nombre, pps.Abreviatura, pps.Descripcion,
                concat(Nombre, ' - ', Abreviatura) as 'PresentacionAbreviatura'
                from productopresentacion as pps
                Where idProductoPresentacion > 0 {0} {1} ; ", oRegistroEN.Where, oRegistroEN.OrderBy);
                Comando.CommandText = Consultas;
        ...
        public bool ValidarSiElRegistroEstaVinculado(ProductoPresentacionEN oRegistroEN, DatosDeConexionEN oDatos, string TipoDeOperacion)
        {
            ...
            try
            {
                ...
                Comando.Parameters.Add(new MySqlParameter("@CampoABuscar_", MySqlDbType.VarChar, 200)).Value = "idProductoPresentacion";
                Comando.Parameters.Add(new MySqlParameter("@ValorCampoABuscar", MySqlDbType.Int32)).Value = oRegistroEN.idProductoPresentacion;
            ...
            try
            {
                ...
                switch (TipoDeOperacion.Trim().ToUpper()){
                    ...
                    case "AGREGAR":
                        ...
                        Consultas = @"SELECT CASE WHEN EXISTS(Select idProductoPresentacion from ProductoPresentacion where upper( trim(Nombre) ) = upper(trim(@Nombre))) THEN 1 ELSE 0 END AS 'RES'";
                    ...
                    case "ACTUALIZAR":
                        ...
                        Consultas = @"SELECT CASE WHEN EXISTS(Select idProductoPresentacion from ProductoPresentacion where upper( trim(Nombre) ) = upper(trim(@Nombre)) and idProductoPresentacion <> @idProductoPresentacion) THEN 1 ELSE 0 END AS 'RES'";
                        Comando.Parameters.Add(new MySqlParameter("@Nombre", MySqlDbType.VarChar, oRegistroEN.Nombre.Trim().Length)).Value = oRegistroEN.Nombre;
                        Comando.Parameters.Add(new MySqlParameter("@idProductoPresentacion", MySqlDbType.Int32)).Value = oRegistroEN.idProductoPresentacion;
        ...
        private TransaccionesEN InformacionDelaTransaccion(ProductoPresentacionEN oProductoPresentacion, String TipoDeOperacion, String Descripcion, String Estado)
        {
            TransaccionesEN oRegistroEN = new TransaccionesEN();

            oRegistroEN.idregistro = oProductoPresentacion.idProductoPresentacion;
            oRegistroEN.Modelo = "General";
            oRegistroEN.Modulo = "ProductoPresentacionAD";
            oRegistroEN.Tabla = "ProductoPresentacion";
            oRegistroEN.tipodeoperacion = TipoDeOperacion;
            oRegistroEN.Estado = Estado;
            oRegistroEN.ip = oProductoPresentacion.oLoginEN.NumeroIP;
            oRegistroEN.idusuario = oProductoPresentacion.oLoginEN.idUsuario;
            oRegistroEN.idusuarioaprueba = oProductoPresentacion.oLoginEN.idUsuario;
            oRegistroEN.descripciondelusuario = DescripcionDeOperacion;
            oRegistroEN.descripcioninterna = Descripcion;
            oRegistroEN.NombreDelEquipo = oProductoPresentacion.oLoginEN.NombreDelComputador;

            return oRegistroEN;
        }
        
        private string InformacionDelRegistro(ProductoPresentacionEN oRegistroEN) {
            string Cadena = @"idProductoPresentacion: {0}, Nombre: {1}, Descripcion: {2}, Abreviatura: {7}, idUsuarioDeCreacion: {3}, FechaDeCreacion: {4}, idUsuarioModificacion: {5}, FechaDeModificacion: {6}";
            Cadena = string.Format(Cadena, oRegistroEN.idProductoPresentacion, oRegistroEN.Nombre, oRegistroEN.Descripcion, oRegistroEN.idUsuarioDeCreacion, oRegistroEN.FechaDeCreacion, oRegistroEN.idUsuarioModificacion, oRegistroEN.FechaDeModificacion,oRegistroEN.Abreviatura);
